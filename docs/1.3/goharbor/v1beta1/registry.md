...
## obj spec.storage.driver.gcs

"An implementation of the storagedriver.StorageDriver interface which uses Google Cloud for object storage. https://docs.docker.com/registry/storage-drivers/gcs/"

### fn spec.storage.driver.gcs.withBucket
...
### fn spec.storage.driver.gcs.withChunkSize
...
### fn spec.storage.driver.gcs.withKeyDataRef
...
### fn spec.storage.driver.gcs.withPathPrefix
...
### fn spec.storage.driver.s3.withMultipartcopychunksize
...
### fn spec.storage.driver.s3.withMultipartcopymaxconcurrency
...
### fn spec.storage.driver.s3.withMultipartcopythresholdsize
