---
permalink: /1.3/goharbor/v1beta1/pullSecretBinding/
---

# goharbor.v1beta1.pullSecretBinding
...
* [`obj spec`](#obj-spec)
  * [`fn withHarborServerConfig(harborServerConfig)`](#fn-specwithharborserverconfig)
  * [`fn withProjectId(projectId)`](#fn-specwithprojectid)
  * [`fn withRobotId(robotId)`](#fn-specwithrobotid)
...
new returns an instance of PullSecretBinding
...
### fn spec.withHarborServerConfig

```ts
withHarborServerConfig(harborServerConfig)
```
