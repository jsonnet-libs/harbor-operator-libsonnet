---
permalink: /1.3/goharbor/v1beta1/harborServerConfiguration/
---

# goharbor.v1beta1.harborServerConfiguration
...
* [`obj spec`](#obj-spec)
  ...
  * [`fn withServerURL(serverURL)`](#fn-specwithserverurl)
  * [`fn withVersion(version)`](#fn-specwithversion)
  * [`obj spec.accessCredential`](#obj-specaccesscredential)
    * [`fn withAccessSecretRef(accessSecretRef)`](#fn-specaccesscredentialwithaccesssecretref)
    * [`fn withNamespace(namespace)`](#fn-specaccesscredentialwithnamespace)
...
new returns an instance of HarborServerConfiguration
...
### fn spec.accessCredential.withNamespace
...
"NamespaceSelector decides whether to apply the HSC on a namespace based on whether the namespace matches the selector. See https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ for more examples of label selectors. \n Default to the empty LabelSelector, which matches everything."
