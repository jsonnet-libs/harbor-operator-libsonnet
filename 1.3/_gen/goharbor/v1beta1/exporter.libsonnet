{
  ...
  '#':: d.pkg(name='exporter', url='', help='"Exporter is the Schema for the Exporter API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Exporter', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1beta1',
    kind: 'Exporter',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ExporterSpec defines the desired state of Exporter."'),
  spec: {
    '#cache':: d.obj(help=''),
    cache: {
      ...
      withCleanInterval(cleanInterval): { spec+: { cache+: { cleanInterval: cleanInterval } } },
      '#withDuration':: d.fn(help='"The duration to cache info from the database and core."', args=[d.arg(name='duration', type=d.T.string)]),
      withDuration(duration): { spec+: { cache+: { duration: duration } } },
    },
    '#core':: d.obj(help=''),
    core: {
      '#withUrl':: d.fn(help='"The absolute Harbor Core URL."', args=[d.arg(name='url', type=d.T.string)]),
    ...
    jobservice: {
      ...
      redisPool: {
        ...
        withCertificateRef(certificateRef): { spec+: { jobservice+: { redisPool+: { certificateRef: certificateRef } } } },
        '#withDatabase':: d.fn(help='"The database number."', args=[d.arg(name='database', type=d.T.integer)]),
        withDatabase(database): { spec+: { jobservice+: { redisPool+: { database: database } } } },
        '#withHost':: d.fn(help='"Server hostname."', args=[d.arg(name='host', type=d.T.string)]),
        withHost(host): { spec+: { jobservice+: { redisPool+: { host: host } } } },
        ...
        withIdleTimeout(idleTimeout): { spec+: { jobservice+: { redisPool+: { idleTimeout: idleTimeout } } } },
        '#withNamespace':: d.fn(help='', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { jobservice+: { redisPool+: { namespace: namespace } } } },
        ...
        withPasswordRef(passwordRef): { spec+: { jobservice+: { redisPool+: { passwordRef: passwordRef } } } },
        '#withPort':: d.fn(help='"Server port."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { spec+: { jobservice+: { redisPool+: { port: port } } } },
        '#withSentinelMasterSet':: d.fn(help='"for Sentinel MasterSet."', args=[d.arg(name='sentinelMasterSet', type=d.T.string)]),
        withSentinelMasterSet(sentinelMasterSet): { spec+: { jobservice+: { redisPool+: { sentinelMasterSet: sentinelMasterSet } } } },
      },
    },
    '#log':: d.obj(help=''),
    log: {
      '#withLevel':: d.fn(help='"ExporterLogLevel is the log level for Exporter."', args=[d.arg(name='level', type=d.T.string)]),
