{
  ...
  '#':: d.pkg(name='harbor', url='', help='"Harbor is the Schema for the harbors API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Harbor', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1beta1',
    kind: 'Harbor',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"HarborSpec defines the desired state of Harbor."'),
  spec: {
    ...
    imageChartStorage: {
      ...
      azure: {
        ...
        withAccountkeyRef(accountkeyRef): { spec+: { imageChartStorage+: { azure+: { accountkeyRef: accountkeyRef } } } },
        '#withAccountname':: d.fn(help='', args=[d.arg(name='accountname', type=d.T.string)]),
        withAccountname(accountname): { spec+: { imageChartStorage+: { azure+: { accountname: accountname } } } },
        '#withBaseURL':: d.fn(help='', args=[d.arg(name='baseURL', type=d.T.string)]),
        withBaseURL(baseURL): { spec+: { imageChartStorage+: { azure+: { baseURL: baseURL } } } },
        '#withContainer':: d.fn(help='', args=[d.arg(name='container', type=d.T.string)]),
        withContainer(container): { spec+: { imageChartStorage+: { azure+: { container: container } } } },
        '#withPathPrefix':: d.fn(help='', args=[d.arg(name='pathPrefix', type=d.T.string)]),
        withPathPrefix(pathPrefix): { spec+: { imageChartStorage+: { azure+: { pathPrefix: pathPrefix } } } },
      },
      ...
      '#gcs':: d.obj(help='"An implementation of the storagedriver.StorageDriver interface which uses Google Cloud for object storage. See https://docs.docker.com/registry/storage-drivers/gcs/"'),
      gcs: {
        '#withBucket':: d.fn(help='"bucket to store charts for Gcs storage"', args=[d.arg(name='bucket', type=d.T.string)]),
        withBucket(bucket): { spec+: { imageChartStorage+: { gcs+: { bucket: bucket } } } },
        '#withChunkSize':: d.fn(help='', args=[d.arg(name='chunkSize', type=d.T.string)]),
        withChunkSize(chunkSize): { spec+: { imageChartStorage+: { gcs+: { chunkSize: chunkSize } } } },
        '#withKeyDataRef':: d.fn(help='"The base64 encoded json file which contains the key"', args=[d.arg(name='keyDataRef', type=d.T.string)]),
        withKeyDataRef(keyDataRef): { spec+: { imageChartStorage+: { gcs+: { keyDataRef: keyDataRef } } } },
        '#withPathPrefix':: d.fn(help='', args=[d.arg(name='pathPrefix', type=d.T.string)]),
        withPathPrefix(pathPrefix): { spec+: { imageChartStorage+: { gcs+: { pathPrefix: pathPrefix } } } },
      },
      '#redirect':: d.obj(help=''),
      redirect: {
      ...
      s3: {
        ...
        withMultipartcopychunksize(multipartcopychunksize): { spec+: { imageChartStorage+: { s3+: { multipartcopychunksize: multipartcopychunksize } } } },
        '#withMultipartcopymaxconcurrency':: d.fn(help='', args=[d.arg(name='multipartcopymaxconcurrency', type=d.T.integer)]),
        withMultipartcopymaxconcurrency(multipartcopymaxconcurrency): { spec+: { imageChartStorage+: { s3+: { multipartcopymaxconcurrency: multipartcopymaxconcurrency } } } },
        '#withMultipartcopythresholdsize':: d.fn(help='', args=[d.arg(name='multipartcopythresholdsize', type=d.T.integer)]),
        withMultipartcopythresholdsize(multipartcopythresholdsize): { spec+: { imageChartStorage+: { s3+: { multipartcopythresholdsize: multipartcopythresholdsize } } } },
