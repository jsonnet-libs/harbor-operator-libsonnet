{
  ...
  '#':: d.pkg(name='portal', url='', help='"Portal is the Schema for the portals API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Portal', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1beta1',
    kind: 'Portal',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"PortalSpec defines the desired state of Portal."'),
  spec: {
    ...
    '#network':: d.obj(help='"Network settings for the portal"'),
    network: {
    ...
    '#withMaxConnections':: d.fn(help='"Sets the maximum number of simultaneous connections that can be opened."', args=[d.arg(name='maxConnections', type=d.T.integer)]),
    withMaxConnections(maxConnections): { spec+: { maxConnections: maxConnections } },
