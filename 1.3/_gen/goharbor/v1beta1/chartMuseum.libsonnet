{
  ...
  '#':: d.pkg(name='chartMuseum', url='', help='"ChartMuseum is the Schema for the ChartMuseum API."'),
  ...
  '#new':: d.fn(help='new returns an instance of ChartMuseum', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1beta1',
    kind: 'ChartMuseum',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"ChartMuseumSpec defines the desired state of ChartMuseum."'),
  spec: {
    '#authentication':: d.obj(help=''),
    authentication: {
      '#bearer':: d.obj(help='"Bearer authentication specs"'),
      bearer: {
        '#withCertificateRef':: d.fn(help='"Reference to secret containing authorization server certificate"', args=[d.arg(name='certificateRef', type=d.T.string)]),
        withCertificateRef(certificateRef): { spec+: { authentication+: { bearer+: { certificateRef: certificateRef } } } },
        '#withRealm':: d.fn(help='"Authorization server url"', args=[d.arg(name='realm', type=d.T.string)]),
        withRealm(realm): { spec+: { authentication+: { bearer+: { realm: realm } } } },
        '#withService':: d.fn(help='"Authorization server service name"', args=[d.arg(name='service', type=d.T.string)]),
        withService(service): { spec+: { authentication+: { bearer+: { service: service } } } },
      },
      '#withAnonymousGet':: d.fn(help='"Allow anonymous GET operations when auth is used"', args=[d.arg(name='anonymousGet', type=d.T.boolean)]),
      withAnonymousGet(anonymousGet): { spec+: { authentication+: { anonymousGet: anonymousGet } } },
      '#withBasicAuthRef':: d.fn(help='"Reference to secret containing basic http authentication Harbor: Harbor try to connect using chart_controller username"', args=[d.arg(name='basicAuthRef', type=d.T.string)]),
      withBasicAuthRef(basicAuthRef): { spec+: { authentication+: { basicAuthRef: basicAuthRef } } },
    },
    '#cache':: d.obj(help='"Cache stores"'),
    cache: {
      ...
      redis: {
        ...
        withCertificateRef(certificateRef): { spec+: { cache+: { redis+: { certificateRef: certificateRef } } } },
        '#withDatabase':: d.fn(help='"The database number."', args=[d.arg(name='database', type=d.T.integer)]),
        withDatabase(database): { spec+: { cache+: { redis+: { database: database } } } },
        '#withHost':: d.fn(help='"Server hostname."', args=[d.arg(name='host', type=d.T.string)]),
        withHost(host): { spec+: { cache+: { redis+: { host: host } } } },
        ...
        withPasswordRef(passwordRef): { spec+: { cache+: { redis+: { passwordRef: passwordRef } } } },
        '#withPort':: d.fn(help='"Server port."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { spec+: { cache+: { redis+: { port: port } } } },
        '#withSentinelMasterSet':: d.fn(help='"for Sentinel MasterSet."', args=[d.arg(name='sentinelMasterSet', type=d.T.string)]),
        withSentinelMasterSet(sentinelMasterSet): { spec+: { cache+: { redis+: { sentinelMasterSet: sentinelMasterSet } } } },
      },
    },
    '#chart':: d.obj(help=''),
    chart: {
      '#index':: d.obj(help=''),
      index: {
        '#withParallelLimit':: d.fn(help='"Parallel scan limit for the repo indexer"', args=[d.arg(name='parallelLimit', type=d.T.integer)]),
        withParallelLimit(parallelLimit): { spec+: { chart+: { index+: { parallelLimit: parallelLimit } } } },
        '#withStorageTimestampTolerance':: d.fn(help='"Timestamp drift tolerated between cached and generated index before invalidation"', args=[d.arg(name='storageTimestampTolerance', type=d.T.string)]),
        withStorageTimestampTolerance(storageTimestampTolerance): { spec+: { chart+: { index+: { storageTimestampTolerance: storageTimestampTolerance } } } },
      },
      '#postFormFieldName':: d.obj(help='"Form fields which will be queried"'),
      postFormFieldName: {
        '#withChart':: d.fn(help='"Form field which will be queried for the chart file content Harbor: Expecting chart to use with Harbor"', args=[d.arg(name='chart', type=d.T.string)]),
        withChart(chart): { spec+: { chart+: { postFormFieldName+: { chart: chart } } } },
        '#withProvenance':: d.fn(help='"Form field which will be queried for the provenance file content Harbor: Expecting prov to use with Harbor"', args=[d.arg(name='provenance', type=d.T.string)]),
        withProvenance(provenance): { spec+: { chart+: { postFormFieldName+: { provenance: provenance } } } },
      },
      '#repo':: d.obj(help=''),
      repo: {
        '#withDepth':: d.fn(help='"Levels of nested repos for multitenancy Harbor: must be set to 1 to support project namespace"', args=[d.arg(name='depth', type=d.T.integer)]),
        withDepth(depth): { spec+: { chart+: { repo+: { depth: depth } } } },
        '#withDepthDynamic':: d.fn(help='"The length of repo variable"', args=[d.arg(name='depthDynamic', type=d.T.boolean)]),
        withDepthDynamic(depthDynamic): { spec+: { chart+: { repo+: { depthDynamic: depthDynamic } } } },
      },
      '#storage':: d.obj(help=''),
      storage: {
        '#amazon':: d.obj(help=''),
        amazon: {
          '#withAccessKeyID':: d.fn(help='', args=[d.arg(name='accessKeyID', type=d.T.string)]),
          withAccessKeyID(accessKeyID): { spec+: { chart+: { storage+: { amazon+: { accessKeyID: accessKeyID } } } } },
          '#withAccessSecretRef':: d.fn(help='', args=[d.arg(name='accessSecretRef', type=d.T.string)]),
          withAccessSecretRef(accessSecretRef): { spec+: { chart+: { storage+: { amazon+: { accessSecretRef: accessSecretRef } } } } },
          '#withBucket':: d.fn(help='"S3 bucket to store charts for amazon storage"', args=[d.arg(name='bucket', type=d.T.string)]),
          withBucket(bucket): { spec+: { chart+: { storage+: { amazon+: { bucket: bucket } } } } },
          '#withEndpoint':: d.fn(help='"Alternative s3 endpoint"', args=[d.arg(name='endpoint', type=d.T.string)]),
          withEndpoint(endpoint): { spec+: { chart+: { storage+: { amazon+: { endpoint: endpoint } } } } },
          '#withPrefix':: d.fn(help='"Prefix to store charts for the bucket"', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { chart+: { storage+: { amazon+: { prefix: prefix } } } } },
          '#withRegion':: d.fn(help='"Region of the bucket"', args=[d.arg(name='region', type=d.T.string)]),
          withRegion(region): { spec+: { chart+: { storage+: { amazon+: { region: region } } } } },
          '#withServerSideEncryption':: d.fn(help='"ServerSideEncryption is the algorithm for server side encryption"', args=[d.arg(name='serverSideEncryption', type=d.T.string)]),
          withServerSideEncryption(serverSideEncryption): { spec+: { chart+: { storage+: { amazon+: { serverSideEncryption: serverSideEncryption } } } } },
        },
        '#azure':: d.obj(help=''),
        azure: {
          '#withAccountkeyRef':: d.fn(help='', args=[d.arg(name='accountkeyRef', type=d.T.string)]),
          withAccountkeyRef(accountkeyRef): { spec+: { chart+: { storage+: { azure+: { accountkeyRef: accountkeyRef } } } } },
          '#withAccountname':: d.fn(help='', args=[d.arg(name='accountname', type=d.T.string)]),
          withAccountname(accountname): { spec+: { chart+: { storage+: { azure+: { accountname: accountname } } } } },
          '#withBaseURL':: d.fn(help='', args=[d.arg(name='baseURL', type=d.T.string)]),
          withBaseURL(baseURL): { spec+: { chart+: { storage+: { azure+: { baseURL: baseURL } } } } },
          '#withContainer':: d.fn(help='', args=[d.arg(name='container', type=d.T.string)]),
          withContainer(container): { spec+: { chart+: { storage+: { azure+: { container: container } } } } },
          '#withPathPrefix':: d.fn(help='', args=[d.arg(name='pathPrefix', type=d.T.string)]),
          withPathPrefix(pathPrefix): { spec+: { chart+: { storage+: { azure+: { pathPrefix: pathPrefix } } } } },
        },
        ...
        filesystem: {
          ...
          volumeSource: {
            ...
            awsElasticBlockStore: {
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { awsElasticBlockStore+: { fsType: fsType } } } } } } },
              ...
              withPartition(partition): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { awsElasticBlockStore+: { partition: partition } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { awsElasticBlockStore+: { readOnly: readOnly } } } } } } },
              ...
              withVolumeID(volumeID): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { awsElasticBlockStore+: { volumeID: volumeID } } } } } } },
            },
            ...
            azureDisk: {
              ...
              withCachingMode(cachingMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureDisk+: { cachingMode: cachingMode } } } } } } },
              '#withDiskName':: d.fn(help='"The Name of the data disk in the blob storage"', args=[d.arg(name='diskName', type=d.T.string)]),
              withDiskName(diskName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureDisk+: { diskName: diskName } } } } } } },
              '#withDiskURI':: d.fn(help='"The URI the data disk in the blob storage"', args=[d.arg(name='diskURI', type=d.T.string)]),
              withDiskURI(diskURI): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureDisk+: { diskURI: diskURI } } } } } } },
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureDisk+: { fsType: fsType } } } } } } },
              ...
              withKind(kind): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureDisk+: { kind: kind } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureDisk+: { readOnly: readOnly } } } } } } },
            },
            '#azureFile':: d.obj(help='"AzureFile represents an Azure File Service mount on the host and bind mount to the pod."'),
            azureFile: {
              '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureFile+: { readOnly: readOnly } } } } } } },
              ...
              withSecretName(secretName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureFile+: { secretName: secretName } } } } } } },
              '#withShareName':: d.fn(help='"Share Name"', args=[d.arg(name='shareName', type=d.T.string)]),
              withShareName(shareName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { azureFile+: { shareName: shareName } } } } } } },
            },
            ...
            cephfs: {
              ...
              secretRef: {
                ...
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { secretRef+: { name: name } } } } } } } },
              },
              ...
              withMonitors(monitors): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { monitors: if std.isArray(v=monitors) then monitors else [monitors] } } } } } } },
              ...
              withMonitorsMixin(monitors): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { monitors+: if std.isArray(v=monitors) then monitors else [monitors] } } } } } } },
              ...
              withPath(path): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { path: path } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { readOnly: readOnly } } } } } } },
              ...
              withSecretFile(secretFile): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { secretFile: secretFile } } } } } } },
              ...
              withUser(user): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cephfs+: { user: user } } } } } } },
            },
            ...
            cinder: {
              ...
              secretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cinder+: { secretRef+: { name: name } } } } } } } },
              },
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cinder+: { fsType: fsType } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cinder+: { readOnly: readOnly } } } } } } },
              ...
              withVolumeID(volumeID): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { cinder+: { volumeID: volumeID } } } } } } },
            },
            ...
            configMap: {
              ...
              withDefaultMode(defaultMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { configMap+: { defaultMode: defaultMode } } } } } } },
              '#withItems':: d.fn(help="\"If unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the ConfigMap, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.\"", args=[d.arg(name='items', type=d.T.array)]),
              withItems(items): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { configMap+: { items: if std.isArray(v=items) then items else [items] } } } } } } },
              ...
              withItemsMixin(items): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { configMap+: { items+: if std.isArray(v=items) then items else [items] } } } } } } },
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { configMap+: { name: name } } } } } } },
              ...
              withOptional(optional): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { configMap+: { optional: optional } } } } } } },
            },
            ...
            csi: {
              ...
              nodePublishSecretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { csi+: { nodePublishSecretRef+: { name: name } } } } } } } },
              },
              ...
              withDriver(driver): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { csi+: { driver: driver } } } } } } },
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { csi+: { fsType: fsType } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { csi+: { readOnly: readOnly } } } } } } },
              ...
              withVolumeAttributes(volumeAttributes): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { csi+: { volumeAttributes: volumeAttributes } } } } } } },
              ...
              withVolumeAttributesMixin(volumeAttributes): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { csi+: { volumeAttributes+: volumeAttributes } } } } } } },
            },
            ...
            downwardAPI: {
              ...
              withDefaultMode(defaultMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { downwardAPI+: { defaultMode: defaultMode } } } } } } },
              '#withItems':: d.fn(help='"Items is a list of downward API volume file"', args=[d.arg(name='items', type=d.T.array)]),
              withItems(items): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { downwardAPI+: { items: if std.isArray(v=items) then items else [items] } } } } } } },
              '#withItemsMixin':: d.fn(help='"Items is a list of downward API volume file"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
              withItemsMixin(items): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { downwardAPI+: { items+: if std.isArray(v=items) then items else [items] } } } } } } },
            },
            ...
            emptyDir: {
              ...
              withMedium(medium): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { emptyDir+: { medium: medium } } } } } } },
              ...
              withSizeLimit(sizeLimit): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { emptyDir+: { sizeLimit: sizeLimit } } } } } } },
            },
              ...
              volumeClaimTemplate: {
                ...
                spec: {
                  ...
                  dataSource: {
                    ...
                    withApiGroup(apiGroup): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSource+: { apiGroup: apiGroup } } } } } } } } } },
                    '#withKind':: d.fn(help='"Kind is the type of resource being referenced"', args=[d.arg(name='kind', type=d.T.string)]),
                    withKind(kind): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSource+: { kind: kind } } } } } } } } } },
                    '#withName':: d.fn(help='"Name is the name of resource being referenced"', args=[d.arg(name='name', type=d.T.string)]),
                    withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSource+: { name: name } } } } } } } } } },
                  },
                  ...
                  dataSourceRef: {
                    '#withApiGroup':: d.fn(help='"APIGroup is the group for the resource being referenced. If APIGroup is not specified, the specified Kind must be in the core API group. For any other third-party types, APIGroup is required."', args=[d.arg(name='apiGroup', type=d.T.string)]),
                    withApiGroup(apiGroup): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { apiGroup: apiGroup } } } } } } } } } },
                    '#withKind':: d.fn(help='"Kind is the type of resource being referenced"', args=[d.arg(name='kind', type=d.T.string)]),
                    withKind(kind): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { kind: kind } } } } } } } } } },
                    '#withName':: d.fn(help='"Name is the name of resource being referenced"', args=[d.arg(name='name', type=d.T.string)]),
                    withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { name: name } } } } } } } } } },
                  },
                  ...
                  resources: {
                    ...
                    withLimits(limits): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { limits: limits } } } } } } } } } },
                    ...
                    withLimitsMixin(limits): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { limits+: limits } } } } } } } } } },
                    ...
                    withRequests(requests): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { requests: requests } } } } } } } } } },
                    ...
                    withRequestsMixin(requests): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { requests+: requests } } } } } } } } } },
                  },
                  ...
                  selector: {
                    ...
                    withMatchExpressions(matchExpressions): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } } } } } },
                    '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
                    withMatchExpressionsMixin(matchExpressions): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } } } } } },
                    '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
                    withMatchLabels(matchLabels): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchLabels: matchLabels } } } } } } } } } },
                    ...
                    withMatchLabelsMixin(matchLabels): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchLabels+: matchLabels } } } } } } } } } },
                  },
                  ...
                  withAccessModes(accessModes): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } } } } } },
                  ...
                  withAccessModesMixin(accessModes): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } } } } } },
                  ...
                  withStorageClassName(storageClassName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { storageClassName: storageClassName } } } } } } } } },
                  ...
                  withVolumeMode(volumeMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { volumeMode: volumeMode } } } } } } } } },
                  ...
                  withVolumeName(volumeName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { spec+: { volumeName: volumeName } } } } } } } } },
                },
                ...
                withMetadata(metadata): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { metadata: metadata } } } } } } } },
                ...
                withMetadataMixin(metadata): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { ephemeral+: { volumeClaimTemplate+: { metadata+: metadata } } } } } } } },
              },
            },
            ...
            fc: {
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { fsType: fsType } } } } } } },
              '#withLun':: d.fn(help='"Optional: FC target lun number"', args=[d.arg(name='lun', type=d.T.integer)]),
              withLun(lun): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { lun: lun } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { readOnly: readOnly } } } } } } },
              '#withTargetWWNs':: d.fn(help='"Optional: FC target worldwide names (WWNs)"', args=[d.arg(name='targetWWNs', type=d.T.array)]),
              withTargetWWNs(targetWWNs): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { targetWWNs: if std.isArray(v=targetWWNs) then targetWWNs else [targetWWNs] } } } } } } },
              ...
              withTargetWWNsMixin(targetWWNs): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { targetWWNs+: if std.isArray(v=targetWWNs) then targetWWNs else [targetWWNs] } } } } } } },
              ...
              withWwids(wwids): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { wwids: if std.isArray(v=wwids) then wwids else [wwids] } } } } } } },
              ...
              withWwidsMixin(wwids): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { fc+: { wwids+: if std.isArray(v=wwids) then wwids else [wwids] } } } } } } },
            },
            ...
            flexVolume: {
              ...
              secretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flexVolume+: { secretRef+: { name: name } } } } } } } },
              },
              '#withDriver':: d.fn(help='"Driver is the name of the driver to use for this volume."', args=[d.arg(name='driver', type=d.T.string)]),
              withDriver(driver): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flexVolume+: { driver: driver } } } } } } },
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flexVolume+: { fsType: fsType } } } } } } },
              '#withOptions':: d.fn(help='"Optional: Extra command options if any."', args=[d.arg(name='options', type=d.T.object)]),
              withOptions(options): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flexVolume+: { options: options } } } } } } },
              ...
              withOptionsMixin(options): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flexVolume+: { options+: options } } } } } } },
              '#withReadOnly':: d.fn(help='"Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flexVolume+: { readOnly: readOnly } } } } } } },
            },
            ...
            flocker: {
              ...
              withDatasetName(datasetName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flocker+: { datasetName: datasetName } } } } } } },
              ...
              withDatasetUUID(datasetUUID): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { flocker+: { datasetUUID: datasetUUID } } } } } } },
            },
            ...
            gcePersistentDisk: {
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gcePersistentDisk+: { fsType: fsType } } } } } } },
              '#withPartition':: d.fn(help='"The partition in the volume that you want to mount. If omitted, the default is to mount by volume name. Examples: For volume /dev/sda1, you specify the partition as \\"1\\". Similarly, the volume partition for /dev/sda is \\"0\\" (or you can leave the property empty). More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk"', args=[d.arg(name='partition', type=d.T.integer)]),
              withPartition(partition): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gcePersistentDisk+: { partition: partition } } } } } } },
              ...
              withPdName(pdName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gcePersistentDisk+: { pdName: pdName } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gcePersistentDisk+: { readOnly: readOnly } } } } } } },
            },
            ...
            gitRepo: {
              ...
              withDirectory(directory): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gitRepo+: { directory: directory } } } } } } },
              '#withRepository':: d.fn(help='"Repository URL"', args=[d.arg(name='repository', type=d.T.string)]),
              withRepository(repository): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gitRepo+: { repository: repository } } } } } } },
              '#withRevision':: d.fn(help='"Commit hash for the specified revision."', args=[d.arg(name='revision', type=d.T.string)]),
              withRevision(revision): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { gitRepo+: { revision: revision } } } } } } },
            },
            ...
            glusterfs: {
              ...
              withEndpoints(endpoints): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { glusterfs+: { endpoints: endpoints } } } } } } },
              ...
              withPath(path): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { glusterfs+: { path: path } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { glusterfs+: { readOnly: readOnly } } } } } } },
            },
            ...
            hostPath: {
              ...
              withPath(path): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { hostPath+: { path: path } } } } } } },
              ...
              withType(type): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { hostPath+: { type: type } } } } } } },
            },
            ...
            iscsi: {
              ...
              secretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { secretRef+: { name: name } } } } } } } },
              },
              ...
              withChapAuthDiscovery(chapAuthDiscovery): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { chapAuthDiscovery: chapAuthDiscovery } } } } } } },
              ...
              withChapAuthSession(chapAuthSession): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { chapAuthSession: chapAuthSession } } } } } } },
              '#withFsType':: d.fn(help='"Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#iscsi TODO: how do we prevent errors in the filesystem from compromising the machine"', args=[d.arg(name='fsType', type=d.T.string)]),
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { fsType: fsType } } } } } } },
              ...
              withInitiatorName(initiatorName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { initiatorName: initiatorName } } } } } } },
              '#withIqn':: d.fn(help='"Target iSCSI Qualified Name."', args=[d.arg(name='iqn', type=d.T.string)]),
              withIqn(iqn): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { iqn: iqn } } } } } } },
              ...
              withIscsiInterface(iscsiInterface): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { iscsiInterface: iscsiInterface } } } } } } },
              '#withLun':: d.fn(help='"iSCSI Target Lun number."', args=[d.arg(name='lun', type=d.T.integer)]),
              withLun(lun): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { lun: lun } } } } } } },
              ...
              withPortals(portals): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { portals: if std.isArray(v=portals) then portals else [portals] } } } } } } },
              ...
              withPortalsMixin(portals): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { portals+: if std.isArray(v=portals) then portals else [portals] } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { readOnly: readOnly } } } } } } },
              ...
              withTargetPortal(targetPortal): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { iscsi+: { targetPortal: targetPortal } } } } } } },
            },
            ...
            nfs: {
              ...
              withPath(path): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { nfs+: { path: path } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { nfs+: { readOnly: readOnly } } } } } } },
              ...
              withServer(server): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { nfs+: { server: server } } } } } } },
            },
            ...
            persistentVolumeClaim: {
              ...
              withClaimName(claimName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { persistentVolumeClaim+: { claimName: claimName } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { persistentVolumeClaim+: { readOnly: readOnly } } } } } } },
            },
            ...
            photonPersistentDisk: {
              '#withFsType':: d.fn(help='"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified."', args=[d.arg(name='fsType', type=d.T.string)]),
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { photonPersistentDisk+: { fsType: fsType } } } } } } },
              '#withPdID':: d.fn(help='"ID that identifies Photon Controller persistent disk"', args=[d.arg(name='pdID', type=d.T.string)]),
              withPdID(pdID): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { photonPersistentDisk+: { pdID: pdID } } } } } } },
            },
            ...
            portworxVolume: {
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { portworxVolume+: { fsType: fsType } } } } } } },
              '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { portworxVolume+: { readOnly: readOnly } } } } } } },
              '#withVolumeID':: d.fn(help='"VolumeID uniquely identifies a Portworx volume"', args=[d.arg(name='volumeID', type=d.T.string)]),
              withVolumeID(volumeID): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { portworxVolume+: { volumeID: volumeID } } } } } } },
            },
            ...
            projected: {
              ...
              withDefaultMode(defaultMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { projected+: { defaultMode: defaultMode } } } } } } },
              '#withSources':: d.fn(help='"list of volume projections"', args=[d.arg(name='sources', type=d.T.array)]),
              withSources(sources): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { projected+: { sources: if std.isArray(v=sources) then sources else [sources] } } } } } } },
              ...
              withSourcesMixin(sources): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { projected+: { sources+: if std.isArray(v=sources) then sources else [sources] } } } } } } },
            },
            ...
            quobyte: {
              ...
              withGroup(group): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { quobyte+: { group: group } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { quobyte+: { readOnly: readOnly } } } } } } },
              ...
              withRegistry(registry): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { quobyte+: { registry: registry } } } } } } },
              ...
              withTenant(tenant): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { quobyte+: { tenant: tenant } } } } } } },
              '#withUser':: d.fn(help='"User to map volume access to Defaults to serivceaccount user"', args=[d.arg(name='user', type=d.T.string)]),
              withUser(user): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { quobyte+: { user: user } } } } } } },
              ...
              withVolume(volume): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { quobyte+: { volume: volume } } } } } } },
            },
            ...
            rbd: {
              ...
              secretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { secretRef+: { name: name } } } } } } } },
              },
              '#withFsType':: d.fn(help='"Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#rbd TODO: how do we prevent errors in the filesystem from compromising the machine"', args=[d.arg(name='fsType', type=d.T.string)]),
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { fsType: fsType } } } } } } },
              ...
              withImage(image): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { image: image } } } } } } },
              ...
              withKeyring(keyring): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { keyring: keyring } } } } } } },
              ...
              withMonitors(monitors): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { monitors: if std.isArray(v=monitors) then monitors else [monitors] } } } } } } },
              ...
              withMonitorsMixin(monitors): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { monitors+: if std.isArray(v=monitors) then monitors else [monitors] } } } } } } },
              ...
              withPool(pool): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { pool: pool } } } } } } },
              ...
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { readOnly: readOnly } } } } } } },
              ...
              withUser(user): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { rbd+: { user: user } } } } } } },
            },
            ...
            scaleIO: {
              ...
              secretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { secretRef+: { name: name } } } } } } } },
              },
              ...
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { fsType: fsType } } } } } } },
              '#withGateway':: d.fn(help='"The host address of the ScaleIO API Gateway."', args=[d.arg(name='gateway', type=d.T.string)]),
              withGateway(gateway): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { gateway: gateway } } } } } } },
              ...
              withProtectionDomain(protectionDomain): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { protectionDomain: protectionDomain } } } } } } },
              '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { readOnly: readOnly } } } } } } },
              ...
              withSslEnabled(sslEnabled): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { sslEnabled: sslEnabled } } } } } } },
              ...
              withStorageMode(storageMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { storageMode: storageMode } } } } } } },
              ...
              withStoragePool(storagePool): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { storagePool: storagePool } } } } } } },
              '#withSystem':: d.fn(help='"The name of the storage system as configured in ScaleIO."', args=[d.arg(name='system', type=d.T.string)]),
              withSystem(system): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { system: system } } } } } } },
              ...
              withVolumeName(volumeName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { scaleIO+: { volumeName: volumeName } } } } } } },
            },
            ...
            secret: {
              ...
              '#withDefaultMode':: d.fn(help='"Optional: mode bits used to set permissions on created files by default. Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set."', args=[d.arg(name='defaultMode', type=d.T.integer)]),
              withDefaultMode(defaultMode): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { secret+: { defaultMode: defaultMode } } } } } } },
              '#withItems':: d.fn(help="\"If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the Secret, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.\"", args=[d.arg(name='items', type=d.T.array)]),
              withItems(items): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { secret+: { items: if std.isArray(v=items) then items else [items] } } } } } } },
              '#withItemsMixin':: d.fn(help="\"If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the Secret, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='items', type=d.T.array)]),
              withItemsMixin(items): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { secret+: { items+: if std.isArray(v=items) then items else [items] } } } } } } },
              '#withOptional':: d.fn(help='"Specify whether the Secret or its keys must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { secret+: { optional: optional } } } } } } },
              ...
              withSecretName(secretName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { secret+: { secretName: secretName } } } } } } },
            },
            ...
            storageos: {
              ...
              secretRef: {
                '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { storageos+: { secretRef+: { name: name } } } } } } } },
              },
              '#withFsType':: d.fn(help='"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified."', args=[d.arg(name='fsType', type=d.T.string)]),
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { storageos+: { fsType: fsType } } } } } } },
              '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
              withReadOnly(readOnly): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { storageos+: { readOnly: readOnly } } } } } } },
              ...
              withVolumeName(volumeName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { storageos+: { volumeName: volumeName } } } } } } },
              ...
              withVolumeNamespace(volumeNamespace): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { storageos+: { volumeNamespace: volumeNamespace } } } } } } },
            },
            '#vsphereVolume':: d.obj(help='"VsphereVolume represents a vSphere volume attached and mounted on kubelets host machine"'),
            vsphereVolume: {
              '#withFsType':: d.fn(help='"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified."', args=[d.arg(name='fsType', type=d.T.string)]),
              withFsType(fsType): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { vsphereVolume+: { fsType: fsType } } } } } } },
              ...
              withStoragePolicyID(storagePolicyID): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { vsphereVolume+: { storagePolicyID: storagePolicyID } } } } } } },
              ...
              withStoragePolicyName(storagePolicyName): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { vsphereVolume+: { storagePolicyName: storagePolicyName } } } } } } },
              '#withVolumePath':: d.fn(help='"Path that identifies vSphere volume vmdk"', args=[d.arg(name='volumePath', type=d.T.string)]),
              withVolumePath(volumePath): { spec+: { chart+: { storage+: { filesystem+: { volumeSource+: { vsphereVolume+: { volumePath: volumePath } } } } } } },
            },
          },
          '#withPrefix':: d.fn(help='', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { chart+: { storage+: { filesystem+: { prefix: prefix } } } } },
        },
        '#gcs':: d.obj(help=''),
        gcs: {
          '#withBucket':: d.fn(help='"bucket to store charts for Gcs storage"', args=[d.arg(name='bucket', type=d.T.string)]),
          withBucket(bucket): { spec+: { chart+: { storage+: { gcs+: { bucket: bucket } } } } },
          '#withChunksize':: d.fn(help='', args=[d.arg(name='chunksize', type=d.T.string)]),
          withChunksize(chunksize): { spec+: { chart+: { storage+: { gcs+: { chunksize: chunksize } } } } },
          '#withKeyDataSecretRef':: d.fn(help='"The base64 encoded json file which contains the key"', args=[d.arg(name='keyDataSecretRef', type=d.T.string)]),
          withKeyDataSecretRef(keyDataSecretRef): { spec+: { chart+: { storage+: { gcs+: { keyDataSecretRef: keyDataSecretRef } } } } },
          '#withPathPrefix':: d.fn(help='', args=[d.arg(name='pathPrefix', type=d.T.string)]),
          withPathPrefix(pathPrefix): { spec+: { chart+: { storage+: { gcs+: { pathPrefix: pathPrefix } } } } },
        },
        '#openstack':: d.obj(help=''),
        openstack: {
          '#withAuthenticationURL':: d.fn(help='"URL for obtaining an auth token. https://storage.myprovider.com/v2.0 or https://storage.myprovider.com/v3/auth"', args=[d.arg(name='authenticationURL', type=d.T.string)]),
          withAuthenticationURL(authenticationURL): { spec+: { chart+: { storage+: { openstack+: { authenticationURL: authenticationURL } } } } },
          '#withContainer':: d.fn(help='"Container to store charts for openstack storage backend"', args=[d.arg(name='container', type=d.T.string)]),
          withContainer(container): { spec+: { chart+: { storage+: { openstack+: { container: container } } } } },
          ...
          withDomain(domain): { spec+: { chart+: { storage+: { openstack+: { domain: domain } } } } },
          ...
          withDomainID(domainID): { spec+: { chart+: { storage+: { openstack+: { domainID: domainID } } } } },
          '#withPasswordRef':: d.fn(help='"Secret name containing the Openstack password."', args=[d.arg(name='passwordRef', type=d.T.string)]),
          withPasswordRef(passwordRef): { spec+: { chart+: { storage+: { openstack+: { passwordRef: passwordRef } } } } },
          '#withPrefix':: d.fn(help='"Prefix to store charts for the container"', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { chart+: { storage+: { openstack+: { prefix: prefix } } } } },
          '#withRegion':: d.fn(help='"Region of the container"', args=[d.arg(name='region', type=d.T.string)]),
          withRegion(region): { spec+: { chart+: { storage+: { openstack+: { region: region } } } } },
          ...
          withTenant(tenant): { spec+: { chart+: { storage+: { openstack+: { tenant: tenant } } } } },
          ...
          withTenantID(tenantID): { spec+: { chart+: { storage+: { openstack+: { tenantID: tenantID } } } } },
          '#withUserid':: d.fn(help='"The Openstack user id. You can either use username or userid."', args=[d.arg(name='userid', type=d.T.string)]),
          withUserid(userid): { spec+: { chart+: { storage+: { openstack+: { userid: userid } } } } },
          '#withUsername':: d.fn(help='"The Openstack user name. You can either use username or userid."', args=[d.arg(name='username', type=d.T.string)]),
          withUsername(username): { spec+: { chart+: { storage+: { openstack+: { username: username } } } } },
        },
        '#withMaxStorageObject':: d.fn(help='"Maximum number of objects allowed in storage (per tenant)"', args=[d.arg(name='maxStorageObject', type=d.T.integer)]),
        withMaxStorageObject(maxStorageObject): { spec+: { chart+: { storage+: { maxStorageObject: maxStorageObject } } } },
      },
      '#withAllowOverwrite':: d.fn(help='"Allow chart versions to be re-uploaded without ?force querystring"', args=[d.arg(name='allowOverwrite', type=d.T.boolean)]),
      withAllowOverwrite(allowOverwrite): { spec+: { chart+: { allowOverwrite: allowOverwrite } } },
      '#withOnlySemver2':: d.fn(help='"Enforce the chart museum server only accepts the valid chart version as Helm does"', args=[d.arg(name='onlySemver2', type=d.T.boolean)]),
      withOnlySemver2(onlySemver2): { spec+: { chart+: { onlySemver2: onlySemver2 } } },
      '#withUrl':: d.fn(help='"The absolute url for .tgz files in index.yaml"', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { chart+: { url: url } } },
    },
    '#disable':: d.obj(help='"Disable some features"'),
    disable: {
      '#withApi':: d.fn(help='"Disable all routes prefixed with"', args=[d.arg(name='api', type=d.T.boolean)]),
      withApi(api): { spec+: { disable+: { api: api } } },
      '#withDelete':: d.fn(help='"Disable DELETE route"', args=[d.arg(name='delete', type=d.T.boolean)]),
      withDelete(delete): { spec+: { disable+: { delete: delete } } },
      '#withForceOverwrite':: d.fn(help='"Do not allow chart versions to be re-uploaded, even with ?force querystrin"', args=[d.arg(name='forceOverwrite', type=d.T.boolean)]),
      withForceOverwrite(forceOverwrite): { spec+: { disable+: { forceOverwrite: forceOverwrite } } },
      '#withMetrics':: d.fn(help='"Disable Prometheus metrics"', args=[d.arg(name='metrics', type=d.T.boolean)]),
      withMetrics(metrics): { spec+: { disable+: { metrics: metrics } } },
      '#withStatefiles':: d.fn(help='"Disable use of index-cache.yaml"', args=[d.arg(name='statefiles', type=d.T.boolean)]),
      withStatefiles(statefiles): { spec+: { disable+: { statefiles: statefiles } } },
    },
    ...
    '#log':: d.obj(help=''),
    log: {
      '#withDebug':: d.fn(help='"Show debug messages"', args=[d.arg(name='debug', type=d.T.boolean)]),
      withDebug(debug): { spec+: { log+: { debug: debug } } },
      '#withHealth':: d.fn(help='"Log inbound /health requests"', args=[d.arg(name='health', type=d.T.boolean)]),
      withHealth(health): { spec+: { log+: { health: health } } },
      '#withJson':: d.fn(help='"Output structured logs as json"', args=[d.arg(name='json', type=d.T.boolean)]),
      withJson(json): { spec+: { log+: { json: json } } },
      '#withLatencyInteger':: d.fn(help='"log latency as an integer instead of a string"', args=[d.arg(name='latencyInteger', type=d.T.boolean)]),
      withLatencyInteger(latencyInteger): { spec+: { log+: { latencyInteger: latencyInteger } } },
    },
    '#network':: d.obj(help=''),
    network: {
    ...
    server: {
      ...
      '#withCorsAllowOrigin':: d.fn(help='"Value to set in the Access-Control-Allow-Origin HTTP header"', args=[d.arg(name='corsAllowOrigin', type=d.T.string)]),
      withCorsAllowOrigin(corsAllowOrigin): { spec+: { server+: { corsAllowOrigin: corsAllowOrigin } } },
      '#withMaxUploadSize':: d.fn(help='"Max size of post body (in bytes)"', args=[d.arg(name='maxUploadSize', type=d.T.integer)]),
      withMaxUploadSize(maxUploadSize): { spec+: { server+: { maxUploadSize: maxUploadSize } } },
