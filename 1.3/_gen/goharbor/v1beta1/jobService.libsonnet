{
  ...
  '#':: d.pkg(name='jobService', url='', help='"JobService is the Schema for the JobService API."'),
  ...
  '#new':: d.fn(help='new returns an instance of JobService', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1beta1',
    kind: 'JobService',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"JobServiceSpec defines the desired state of JobService."'),
  spec: {
    '#core':: d.obj(help=''),
    core: {
      '#withSecretRef':: d.fn(help='', args=[d.arg(name='secretRef', type=d.T.string)]),
      withSecretRef(secretRef): { spec+: { core+: { secretRef: secretRef } } },
      '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { core+: { url: url } } },
    },
    ...
    '#jobLoggers':: d.obj(help='"Job logger configurations"'),
    jobLoggers: {
      '#database':: d.obj(help=''),
      database: {
        '#withLevel':: d.fn(help='"JobServiceLogLevel is the log level for JobService."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { jobLoggers+: { database+: { level: level } } } },
        '#withSweeper':: d.fn(help='', args=[d.arg(name='sweeper', type=d.T.string)]),
        withSweeper(sweeper): { spec+: { jobLoggers+: { database+: { sweeper: sweeper } } } },
      },
      '#files':: d.obj(help=''),
      files: {
        '#volume':: d.obj(help='"Represents the source of a volume to mount. Only one of its members may be specified."'),
        volume: {
          ...
          awsElasticBlockStore: {
            ...
            withFsType(fsType): { volume+: { awsElasticBlockStore+: { fsType: fsType } } },
            ...
            withPartition(partition): { volume+: { awsElasticBlockStore+: { partition: partition } } },
            ...
            withReadOnly(readOnly): { volume+: { awsElasticBlockStore+: { readOnly: readOnly } } },
            ...
            withVolumeID(volumeID): { volume+: { awsElasticBlockStore+: { volumeID: volumeID } } },
          },
          ...
          azureDisk: {
            ...
            withFsType(fsType): { volume+: { azureDisk+: { fsType: fsType } } },
            ...
            withKind(kind): { volume+: { azureDisk+: { kind: kind } } },
            ...
            withReadOnly(readOnly): { volume+: { azureDisk+: { readOnly: readOnly } } },
          },
          '#azureFile':: d.obj(help='"AzureFile represents an Azure File Service mount on the host and bind mount to the pod."'),
          azureFile: {
            '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
            withReadOnly(readOnly): { volume+: { azureFile+: { readOnly: readOnly } } },
            ...
            withSecretName(secretName): { volume+: { azureFile+: { secretName: secretName } } },
            '#withShareName':: d.fn(help='"Share Name"', args=[d.arg(name='shareName', type=d.T.string)]),
            withShareName(shareName): { volume+: { azureFile+: { shareName: shareName } } },
          },
          ...
          cephfs: {
            ...
            secretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { cephfs+: { secretRef+: { name: name } } } },
            },
            ...
            withMonitors(monitors): { volume+: { cephfs+: { monitors: if std.isArray(v=monitors) then monitors else [monitors] } } },
            ...
            withMonitorsMixin(monitors): { volume+: { cephfs+: { monitors+: if std.isArray(v=monitors) then monitors else [monitors] } } },
            ...
            withPath(path): { volume+: { cephfs+: { path: path } } },
            ...
            withReadOnly(readOnly): { volume+: { cephfs+: { readOnly: readOnly } } },
            ...
            withSecretFile(secretFile): { volume+: { cephfs+: { secretFile: secretFile } } },
            ...
            withUser(user): { volume+: { cephfs+: { user: user } } },
          },
          ...
          cinder: {
            ...
            secretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { cinder+: { secretRef+: { name: name } } } },
            },
            ...
            withFsType(fsType): { volume+: { cinder+: { fsType: fsType } } },
            ...
            withReadOnly(readOnly): { volume+: { cinder+: { readOnly: readOnly } } },
            ...
            withVolumeID(volumeID): { volume+: { cinder+: { volumeID: volumeID } } },
          },
          ...
          configMap: {
            ...
            withDefaultMode(defaultMode): { volume+: { configMap+: { defaultMode: defaultMode } } },
            '#withItems':: d.fn(help="\"If unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the ConfigMap, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.\"", args=[d.arg(name='items', type=d.T.array)]),
            withItems(items): { volume+: { configMap+: { items: if std.isArray(v=items) then items else [items] } } },
            ...
            withItemsMixin(items): { volume+: { configMap+: { items+: if std.isArray(v=items) then items else [items] } } },
            '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { volume+: { configMap+: { name: name } } },
            ...
            withOptional(optional): { volume+: { configMap+: { optional: optional } } },
          },
          ...
          csi: {
            ...
            nodePublishSecretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { csi+: { nodePublishSecretRef+: { name: name } } } },
            },
            ...
            withDriver(driver): { volume+: { csi+: { driver: driver } } },
            ...
            withFsType(fsType): { volume+: { csi+: { fsType: fsType } } },
            ...
            withReadOnly(readOnly): { volume+: { csi+: { readOnly: readOnly } } },
            ...
            withVolumeAttributes(volumeAttributes): { volume+: { csi+: { volumeAttributes: volumeAttributes } } },
            ...
            withVolumeAttributesMixin(volumeAttributes): { volume+: { csi+: { volumeAttributes+: volumeAttributes } } },
          },
          ...
          downwardAPI: {
            ...
            withDefaultMode(defaultMode): { volume+: { downwardAPI+: { defaultMode: defaultMode } } },
            '#withItems':: d.fn(help='"Items is a list of downward API volume file"', args=[d.arg(name='items', type=d.T.array)]),
            withItems(items): { volume+: { downwardAPI+: { items: if std.isArray(v=items) then items else [items] } } },
            '#withItemsMixin':: d.fn(help='"Items is a list of downward API volume file"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='items', type=d.T.array)]),
            withItemsMixin(items): { volume+: { downwardAPI+: { items+: if std.isArray(v=items) then items else [items] } } },
          },
          ...
          emptyDir: {
            ...
            withMedium(medium): { volume+: { emptyDir+: { medium: medium } } },
            ...
            withSizeLimit(sizeLimit): { volume+: { emptyDir+: { sizeLimit: sizeLimit } } },
          },
            ...
            volumeClaimTemplate: {
              ...
              spec: {
                ...
                dataSource: {
                  ...
                  withApiGroup(apiGroup): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSource+: { apiGroup: apiGroup } } } } } },
                  '#withKind':: d.fn(help='"Kind is the type of resource being referenced"', args=[d.arg(name='kind', type=d.T.string)]),
                  withKind(kind): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSource+: { kind: kind } } } } } },
                  '#withName':: d.fn(help='"Name is the name of resource being referenced"', args=[d.arg(name='name', type=d.T.string)]),
                  withName(name): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSource+: { name: name } } } } } },
                },
                ...
                dataSourceRef: {
                  '#withApiGroup':: d.fn(help='"APIGroup is the group for the resource being referenced. If APIGroup is not specified, the specified Kind must be in the core API group. For any other third-party types, APIGroup is required."', args=[d.arg(name='apiGroup', type=d.T.string)]),
                  withApiGroup(apiGroup): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { apiGroup: apiGroup } } } } } },
                  '#withKind':: d.fn(help='"Kind is the type of resource being referenced"', args=[d.arg(name='kind', type=d.T.string)]),
                  withKind(kind): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { kind: kind } } } } } },
                  '#withName':: d.fn(help='"Name is the name of resource being referenced"', args=[d.arg(name='name', type=d.T.string)]),
                  withName(name): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { name: name } } } } } },
                },
                ...
                resources: {
                  ...
                  withLimits(limits): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { limits: limits } } } } } },
                  ...
                  withLimitsMixin(limits): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { limits+: limits } } } } } },
                  ...
                  withRequests(requests): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { requests: requests } } } } } },
                  ...
                  withRequestsMixin(requests): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { resources+: { requests+: requests } } } } } },
                },
                ...
                selector: {
                  ...
                  withMatchExpressions(matchExpressions): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } },
                  '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
                  withMatchExpressionsMixin(matchExpressions): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } },
                  '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
                  withMatchLabels(matchLabels): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchLabels: matchLabels } } } } } },
                  ...
                  withMatchLabelsMixin(matchLabels): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchLabels+: matchLabels } } } } } },
                },
                ...
                withAccessModes(accessModes): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } },
                ...
                withAccessModesMixin(accessModes): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } },
                ...
                withStorageClassName(storageClassName): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { storageClassName: storageClassName } } } } },
                ...
                withVolumeMode(volumeMode): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { volumeMode: volumeMode } } } } },
                ...
                withVolumeName(volumeName): { volume+: { ephemeral+: { volumeClaimTemplate+: { spec+: { volumeName: volumeName } } } } },
              },
              ...
              withMetadata(metadata): { volume+: { ephemeral+: { volumeClaimTemplate+: { metadata: metadata } } } },
              ...
              withMetadataMixin(metadata): { volume+: { ephemeral+: { volumeClaimTemplate+: { metadata+: metadata } } } },
            },
          },
          ...
          fc: {
            ...
            withReadOnly(readOnly): { volume+: { fc+: { readOnly: readOnly } } },
            '#withTargetWWNs':: d.fn(help='"Optional: FC target worldwide names (WWNs)"', args=[d.arg(name='targetWWNs', type=d.T.array)]),
            withTargetWWNs(targetWWNs): { volume+: { fc+: { targetWWNs: if std.isArray(v=targetWWNs) then targetWWNs else [targetWWNs] } } },
            ...
            withTargetWWNsMixin(targetWWNs): { volume+: { fc+: { targetWWNs+: if std.isArray(v=targetWWNs) then targetWWNs else [targetWWNs] } } },
            ...
            withWwids(wwids): { volume+: { fc+: { wwids: if std.isArray(v=wwids) then wwids else [wwids] } } },
            ...
            withWwidsMixin(wwids): { volume+: { fc+: { wwids+: if std.isArray(v=wwids) then wwids else [wwids] } } },
          },
          ...
          flexVolume: {
            ...
            withFsType(fsType): { volume+: { flexVolume+: { fsType: fsType } } },
            '#withOptions':: d.fn(help='"Optional: Extra command options if any."', args=[d.arg(name='options', type=d.T.object)]),
            withOptions(options): { volume+: { flexVolume+: { options: options } } },
            ...
            withOptionsMixin(options): { volume+: { flexVolume+: { options+: options } } },
            '#withReadOnly':: d.fn(help='"Optional: Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
            withReadOnly(readOnly): { volume+: { flexVolume+: { readOnly: readOnly } } },
          },
          ...
          flocker: {
            ...
            withDatasetName(datasetName): { volume+: { flocker+: { datasetName: datasetName } } },
            ...
            withDatasetUUID(datasetUUID): { volume+: { flocker+: { datasetUUID: datasetUUID } } },
          },
          ...
          gcePersistentDisk: {
            ...
            withFsType(fsType): { volume+: { gcePersistentDisk+: { fsType: fsType } } },
            '#withPartition':: d.fn(help='"The partition in the volume that you want to mount. If omitted, the default is to mount by volume name. Examples: For volume /dev/sda1, you specify the partition as \\"1\\". Similarly, the volume partition for /dev/sda is \\"0\\" (or you can leave the property empty). More info: https://kubernetes.io/docs/concepts/storage/volumes#gcepersistentdisk"', args=[d.arg(name='partition', type=d.T.integer)]),
            withPartition(partition): { volume+: { gcePersistentDisk+: { partition: partition } } },
            ...
            withPdName(pdName): { volume+: { gcePersistentDisk+: { pdName: pdName } } },
            ...
            withReadOnly(readOnly): { volume+: { gcePersistentDisk+: { readOnly: readOnly } } },
          },
          ...
          glusterfs: {
            ...
            withEndpoints(endpoints): { volume+: { glusterfs+: { endpoints: endpoints } } },
            ...
            withPath(path): { volume+: { glusterfs+: { path: path } } },
            ...
            withReadOnly(readOnly): { volume+: { glusterfs+: { readOnly: readOnly } } },
          },
          ...
          hostPath: {
            ...
            withPath(path): { volume+: { hostPath+: { path: path } } },
            ...
            withType(type): { volume+: { hostPath+: { type: type } } },
          },
          ...
          iscsi: {
            ...
            secretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { iscsi+: { secretRef+: { name: name } } } },
            },
            ...
            withChapAuthDiscovery(chapAuthDiscovery): { volume+: { iscsi+: { chapAuthDiscovery: chapAuthDiscovery } } },
            ...
            withChapAuthSession(chapAuthSession): { volume+: { iscsi+: { chapAuthSession: chapAuthSession } } },
            '#withFsType':: d.fn(help='"Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#iscsi TODO: how do we prevent errors in the filesystem from compromising the machine"', args=[d.arg(name='fsType', type=d.T.string)]),
            withFsType(fsType): { volume+: { iscsi+: { fsType: fsType } } },
            ...
            withInitiatorName(initiatorName): { volume+: { iscsi+: { initiatorName: initiatorName } } },
            '#withIqn':: d.fn(help='"Target iSCSI Qualified Name."', args=[d.arg(name='iqn', type=d.T.string)]),
            withIqn(iqn): { volume+: { iscsi+: { iqn: iqn } } },
            ...
            withIscsiInterface(iscsiInterface): { volume+: { iscsi+: { iscsiInterface: iscsiInterface } } },
            '#withLun':: d.fn(help='"iSCSI Target Lun number."', args=[d.arg(name='lun', type=d.T.integer)]),
            withLun(lun): { volume+: { iscsi+: { lun: lun } } },
            ...
            withPortals(portals): { volume+: { iscsi+: { portals: if std.isArray(v=portals) then portals else [portals] } } },
            ...
            withPortalsMixin(portals): { volume+: { iscsi+: { portals+: if std.isArray(v=portals) then portals else [portals] } } },
            ...
            withReadOnly(readOnly): { volume+: { iscsi+: { readOnly: readOnly } } },
            ...
            withTargetPortal(targetPortal): { volume+: { iscsi+: { targetPortal: targetPortal } } },
          },
          ...
          nfs: {
            ...
            withPath(path): { volume+: { nfs+: { path: path } } },
            ...
            withReadOnly(readOnly): { volume+: { nfs+: { readOnly: readOnly } } },
            ...
            withServer(server): { volume+: { nfs+: { server: server } } },
          },
          ...
          persistentVolumeClaim: {
            ...
            withClaimName(claimName): { volume+: { persistentVolumeClaim+: { claimName: claimName } } },
            ...
            withReadOnly(readOnly): { volume+: { persistentVolumeClaim+: { readOnly: readOnly } } },
          },
          ...
          photonPersistentDisk: {
            '#withFsType':: d.fn(help='"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified."', args=[d.arg(name='fsType', type=d.T.string)]),
            withFsType(fsType): { volume+: { photonPersistentDisk+: { fsType: fsType } } },
            '#withPdID':: d.fn(help='"ID that identifies Photon Controller persistent disk"', args=[d.arg(name='pdID', type=d.T.string)]),
            withPdID(pdID): { volume+: { photonPersistentDisk+: { pdID: pdID } } },
          },
          ...
          portworxVolume: {
            ...
            withFsType(fsType): { volume+: { portworxVolume+: { fsType: fsType } } },
            '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
            withReadOnly(readOnly): { volume+: { portworxVolume+: { readOnly: readOnly } } },
            '#withVolumeID':: d.fn(help='"VolumeID uniquely identifies a Portworx volume"', args=[d.arg(name='volumeID', type=d.T.string)]),
            withVolumeID(volumeID): { volume+: { portworxVolume+: { volumeID: volumeID } } },
          },
          ...
          projected: {
            ...
            withDefaultMode(defaultMode): { volume+: { projected+: { defaultMode: defaultMode } } },
            '#withSources':: d.fn(help='"list of volume projections"', args=[d.arg(name='sources', type=d.T.array)]),
            withSources(sources): { volume+: { projected+: { sources: if std.isArray(v=sources) then sources else [sources] } } },
            ...
            withSourcesMixin(sources): { volume+: { projected+: { sources+: if std.isArray(v=sources) then sources else [sources] } } },
          },
          ...
          quobyte: {
            ...
            withGroup(group): { volume+: { quobyte+: { group: group } } },
            ...
            withReadOnly(readOnly): { volume+: { quobyte+: { readOnly: readOnly } } },
            ...
            withRegistry(registry): { volume+: { quobyte+: { registry: registry } } },
            ...
            withVolume(volume): { volume+: { quobyte+: { volume: volume } } },
          },
          ...
          rbd: {
            ...
            secretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { rbd+: { secretRef+: { name: name } } } },
            },
            '#withFsType':: d.fn(help='"Filesystem type of the volume that you want to mount. Tip: Ensure that the filesystem type is supported by the host operating system. Examples: \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified. More info: https://kubernetes.io/docs/concepts/storage/volumes#rbd TODO: how do we prevent errors in the filesystem from compromising the machine"', args=[d.arg(name='fsType', type=d.T.string)]),
            withFsType(fsType): { volume+: { rbd+: { fsType: fsType } } },
            ...
            withImage(image): { volume+: { rbd+: { image: image } } },
            ...
            withKeyring(keyring): { volume+: { rbd+: { keyring: keyring } } },
            ...
            withMonitors(monitors): { volume+: { rbd+: { monitors: if std.isArray(v=monitors) then monitors else [monitors] } } },
            ...
            withMonitorsMixin(monitors): { volume+: { rbd+: { monitors+: if std.isArray(v=monitors) then monitors else [monitors] } } },
            ...
            withPool(pool): { volume+: { rbd+: { pool: pool } } },
            ...
            withReadOnly(readOnly): { volume+: { rbd+: { readOnly: readOnly } } },
            ...
            withUser(user): { volume+: { rbd+: { user: user } } },
          },
          ...
          scaleIO: {
            ...
            secretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { scaleIO+: { secretRef+: { name: name } } } },
            },
            ...
            withProtectionDomain(protectionDomain): { volume+: { scaleIO+: { protectionDomain: protectionDomain } } },
            '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
            withReadOnly(readOnly): { volume+: { scaleIO+: { readOnly: readOnly } } },
            ...
            withSslEnabled(sslEnabled): { volume+: { scaleIO+: { sslEnabled: sslEnabled } } },
            ...
            withStorageMode(storageMode): { volume+: { scaleIO+: { storageMode: storageMode } } },
            ...
            withVolumeName(volumeName): { volume+: { scaleIO+: { volumeName: volumeName } } },
          },
          ...
          secret: {
            ...
            '#withDefaultMode':: d.fn(help='"Optional: mode bits used to set permissions on created files by default. Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set."', args=[d.arg(name='defaultMode', type=d.T.integer)]),
            withDefaultMode(defaultMode): { volume+: { secret+: { defaultMode: defaultMode } } },
            '#withItems':: d.fn(help="\"If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the Secret, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.\"", args=[d.arg(name='items', type=d.T.array)]),
            withItems(items): { volume+: { secret+: { items: if std.isArray(v=items) then items else [items] } } },
            '#withItemsMixin':: d.fn(help="\"If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value. If specified, the listed keys will be projected into the specified paths, and unlisted keys will not be present. If a key is specified which is not present in the Secret, the volume setup will error unless it is marked optional. Paths must be relative and may not contain the '..' path or start with '..'.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='items', type=d.T.array)]),
            withItemsMixin(items): { volume+: { secret+: { items+: if std.isArray(v=items) then items else [items] } } },
            '#withOptional':: d.fn(help='"Specify whether the Secret or its keys must be defined"', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { volume+: { secret+: { optional: optional } } },
            ...
            withSecretName(secretName): { volume+: { secret+: { secretName: secretName } } },
          },
          ...
          storageos: {
            ...
            secretRef: {
              '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { volume+: { storageos+: { secretRef+: { name: name } } } },
            },
            '#withFsType':: d.fn(help='"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified."', args=[d.arg(name='fsType', type=d.T.string)]),
            withFsType(fsType): { volume+: { storageos+: { fsType: fsType } } },
            '#withReadOnly':: d.fn(help='"Defaults to false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
            withReadOnly(readOnly): { volume+: { storageos+: { readOnly: readOnly } } },
            ...
            withVolumeName(volumeName): { volume+: { storageos+: { volumeName: volumeName } } },
            ...
            withVolumeNamespace(volumeNamespace): { volume+: { storageos+: { volumeNamespace: volumeNamespace } } },
          },
          '#vsphereVolume':: d.obj(help='"VsphereVolume represents a vSphere volume attached and mounted on kubelets host machine"'),
          vsphereVolume: {
            '#withFsType':: d.fn(help='"Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \\"ext4\\", \\"xfs\\", \\"ntfs\\". Implicitly inferred to be \\"ext4\\" if unspecified."', args=[d.arg(name='fsType', type=d.T.string)]),
            withFsType(fsType): { volume+: { vsphereVolume+: { fsType: fsType } } },
            ...
            withStoragePolicyID(storagePolicyID): { volume+: { vsphereVolume+: { storagePolicyID: storagePolicyID } } },
            ...
            withStoragePolicyName(storagePolicyName): { volume+: { vsphereVolume+: { storagePolicyName: storagePolicyName } } },
            '#withVolumePath':: d.fn(help='"Path that identifies vSphere volume vmdk"', args=[d.arg(name='volumePath', type=d.T.string)]),
            withVolumePath(volumePath): { volume+: { vsphereVolume+: { volumePath: volumePath } } },
          },
        },
        '#withLevel':: d.fn(help='"JobServiceLogLevel is the log level for JobService."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { level: level },
        '#withSweeper':: d.fn(help='', args=[d.arg(name='sweeper', type=d.T.string)]),
        withSweeper(sweeper): { sweeper: sweeper },
      },
      '#stdout':: d.obj(help=''),
      stdout: {
        '#withLevel':: d.fn(help='"JobServiceLogLevel is the log level for JobService."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { jobLoggers+: { stdout+: { level: level } } } },
      },
      '#withFiles':: d.fn(help='', args=[d.arg(name='files', type=d.T.array)]),
      withFiles(files): { spec+: { jobLoggers+: { files: if std.isArray(v=files) then files else [files] } } },
      '#withFilesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='files', type=d.T.array)]),
      withFilesMixin(files): { spec+: { jobLoggers+: { files+: if std.isArray(v=files) then files else [files] } } },
    },
    '#loggers':: d.obj(help='"Logger configurations"'),
    loggers: {
      '#database':: d.obj(help=''),
      database: {
        '#withLevel':: d.fn(help='"JobServiceLogLevel is the log level for JobService."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { loggers+: { database+: { level: level } } } },
        '#withSweeper':: d.fn(help='', args=[d.arg(name='sweeper', type=d.T.string)]),
        withSweeper(sweeper): { spec+: { loggers+: { database+: { sweeper: sweeper } } } },
      },
      '#files':: d.obj(help=''),
      files: {
        '#volume':: d.obj(help='"Represents the source of a volume to mount. Only one of its members may be specified."'),
      ...
      stdout: {
        '#withLevel':: d.fn(help='"JobServiceLogLevel is the log level for JobService."', args=[d.arg(name='level', type=d.T.string)]),
        withLevel(level): { spec+: { loggers+: { stdout+: { level: level } } } },
      },
      '#withFiles':: d.fn(help='', args=[d.arg(name='files', type=d.T.array)]),
      withFiles(files): { spec+: { loggers+: { files: if std.isArray(v=files) then files else [files] } } },
      '#withFilesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='files', type=d.T.array)]),
      withFilesMixin(files): { spec+: { loggers+: { files+: if std.isArray(v=files) then files else [files] } } },
    },
    '#metrics':: d.obj(help=''),
    metrics: {
      ...
      withPath(path): { spec+: { metrics+: { path: path } } },
    ...
    registry: {
      ...
      credentials: {
        '#withPasswordRef':: d.fn(help='', args=[d.arg(name='passwordRef', type=d.T.string)]),
        withPasswordRef(passwordRef): { spec+: { registry+: { credentials+: { passwordRef: passwordRef } } } },
        '#withUsername':: d.fn(help='', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { spec+: { registry+: { credentials+: { username: username } } } },
      },
      '#withControllerURL':: d.fn(help='', args=[d.arg(name='controllerURL', type=d.T.string)]),
      withControllerURL(controllerURL): { spec+: { registry+: { controllerURL: controllerURL } } },
      '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { registry+: { url: url } } },
    },
    ...
    '#tokenService':: d.obj(help=''),
    tokenService: {
      '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
      withUrl(url): { spec+: { tokenService+: { url: url } } },
    },
    ...
    '#workerPool':: d.obj(help='"Configurations of worker pool"'),
    workerPool: {
      '#redisPool':: d.obj(help='"RedisPoolConfig keeps redis worker info."'),
      redisPool: {
        ...
        withCertificateRef(certificateRef): { spec+: { workerPool+: { redisPool+: { certificateRef: certificateRef } } } },
        '#withDatabase':: d.fn(help='"The database number."', args=[d.arg(name='database', type=d.T.integer)]),
        withDatabase(database): { spec+: { workerPool+: { redisPool+: { database: database } } } },
        '#withHost':: d.fn(help='"Server hostname."', args=[d.arg(name='host', type=d.T.string)]),
        withHost(host): { spec+: { workerPool+: { redisPool+: { host: host } } } },
        '#withIdleTimeout':: d.fn(help="\"IdleTimeoutSecond closes connections after remaining idle for this duration. If the value is zero, then idle connections are not closed. Applications should set the timeout to a value less than the server's timeout.\"", args=[d.arg(name='idleTimeout', type=d.T.string)]),
        withIdleTimeout(idleTimeout): { spec+: { workerPool+: { redisPool+: { idleTimeout: idleTimeout } } } },
        '#withNamespace':: d.fn(help='', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { workerPool+: { redisPool+: { namespace: namespace } } } },
        ...
        withPasswordRef(passwordRef): { spec+: { workerPool+: { redisPool+: { passwordRef: passwordRef } } } },
        '#withPort':: d.fn(help='"Server port."', args=[d.arg(name='port', type=d.T.integer)]),
        withPort(port): { spec+: { workerPool+: { redisPool+: { port: port } } } },
        '#withSentinelMasterSet':: d.fn(help='"for Sentinel MasterSet."', args=[d.arg(name='sentinelMasterSet', type=d.T.string)]),
        withSentinelMasterSet(sentinelMasterSet): { spec+: { workerPool+: { redisPool+: { sentinelMasterSet: sentinelMasterSet } } } },
      },
      '#withBackend':: d.fn(help='', args=[d.arg(name='backend', type=d.T.string)]),
      withBackend(backend): { spec+: { workerPool+: { backend: backend } } },
      '#withWorkers':: d.fn(help='"Worker concurrency"', args=[d.arg(name='workers', type=d.T.integer)]),
      withWorkers(workers): { spec+: { workerPool+: { workers: workers } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
