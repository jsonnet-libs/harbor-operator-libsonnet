{
  ...
  spec: {
    ...
    '#database':: d.obj(help='"Skip OpenAPI schema validation Use validating webhook to do verification (field required)"'),
    database: {
      '#hosts':: d.obj(help=''),
      hosts: {
      ...
      withHosts(hosts): { spec+: { database+: { hosts: if std.isArray(v=hosts) then hosts else [hosts] } } },
      '#withHostsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='hosts', type=d.T.array)]),
      withHostsMixin(hosts): { spec+: { database+: { hosts+: if std.isArray(v=hosts) then hosts else [hosts] } } },
      ...
      withPasswordRef(passwordRef): { spec+: { database+: { passwordRef: passwordRef } } },
      '#withPrefix':: d.fn(help='', args=[d.arg(name='prefix', type=d.T.string)]),
      withPrefix(prefix): { spec+: { database+: { prefix: prefix } } },
      ...
      withSslMode(sslMode): { spec+: { database+: { sslMode: sslMode } } },
      ...
      withUsername(username): { spec+: { database+: { username: username } } },
    },
    '#exporter':: d.obj(help=''),
    exporter: {
      '#cache':: d.obj(help=''),
    ...
    '#imageChartStorage':: d.obj(help='"Skip OpenAPI schema validation Use validating webhook to do verification (field required)"'),
    imageChartStorage: {
      ...
      filesystem: {
        ...
        chartPersistentVolume: {
          ...
          withClaimName(claimName): { spec+: { imageChartStorage+: { filesystem+: { chartPersistentVolume+: { claimName: claimName } } } } },
          '#withPrefix':: d.fn(help='', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { imageChartStorage+: { filesystem+: { chartPersistentVolume+: { prefix: prefix } } } } },
          ...
          withReadOnly(readOnly): { spec+: { imageChartStorage+: { filesystem+: { chartPersistentVolume+: { readOnly: readOnly } } } } },
        },
        '#registryPersistentVolume':: d.obj(help=''),
        registryPersistentVolume: {
          '#withClaimName':: d.fn(help='"ClaimName is the name of a PersistentVolumeClaim in the same namespace as the pod using this volume. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims"', args=[d.arg(name='claimName', type=d.T.string)]),
          withClaimName(claimName): { spec+: { imageChartStorage+: { filesystem+: { registryPersistentVolume+: { claimName: claimName } } } } },
          '#withMaxthreads':: d.fn(help='', args=[d.arg(name='maxthreads', type=d.T.integer)]),
          withMaxthreads(maxthreads): { spec+: { imageChartStorage+: { filesystem+: { registryPersistentVolume+: { maxthreads: maxthreads } } } } },
          '#withPrefix':: d.fn(help='', args=[d.arg(name='prefix', type=d.T.string)]),
          withPrefix(prefix): { spec+: { imageChartStorage+: { filesystem+: { registryPersistentVolume+: { prefix: prefix } } } } },
          '#withReadOnly':: d.fn(help='"Will force the ReadOnly setting in VolumeMounts. Default false."', args=[d.arg(name='readOnly', type=d.T.boolean)]),
          withReadOnly(readOnly): { spec+: { imageChartStorage+: { filesystem+: { registryPersistentVolume+: { readOnly: readOnly } } } } },
        },
      },
      '#redirect':: d.obj(help=''),
      redirect: {
        '#withDisable':: d.fn(help='', args=[d.arg(name='disable', type=d.T.boolean)]),
        withDisable(disable): { spec+: { imageChartStorage+: { redirect+: { disable: disable } } } },
      },
      ...
      s3: {
        ...
        withAccesskey(accesskey): { spec+: { imageChartStorage+: { s3+: { accesskey: accesskey } } } },
        ...
        withBucket(bucket): { spec+: { imageChartStorage+: { s3+: { bucket: bucket } } } },
        '#withCertificateRef':: d.fn(help='', args=[d.arg(name='certificateRef', type=d.T.string)]),
        withCertificateRef(certificateRef): { spec+: { imageChartStorage+: { s3+: { certificateRef: certificateRef } } } },
        ...
        withChunksize(chunksize): { spec+: { imageChartStorage+: { s3+: { chunksize: chunksize } } } },
        ...
        withEncrypt(encrypt): { spec+: { imageChartStorage+: { s3+: { encrypt: encrypt } } } },
        ...
        withKeyid(keyid): { spec+: { imageChartStorage+: { s3+: { keyid: keyid } } } },
        ...
        withRegion(region): { spec+: { imageChartStorage+: { s3+: { region: region } } } },
        ...
        withRegionendpoint(regionendpoint): { spec+: { imageChartStorage+: { s3+: { regionendpoint: regionendpoint } } } },
        ...
        withRootdirectory(rootdirectory): { spec+: { imageChartStorage+: { s3+: { rootdirectory: rootdirectory } } } },
        ...
        withSecretkeyRef(secretkeyRef): { spec+: { imageChartStorage+: { s3+: { secretkeyRef: secretkeyRef } } } },
        '#withSecure':: d.fn(help='', args=[d.arg(name='secure', type=d.T.boolean)]),
        withSecure(secure): { spec+: { imageChartStorage+: { s3+: { secure: secure } } } },
        ...
        withSkipverify(skipverify): { spec+: { imageChartStorage+: { s3+: { skipverify: skipverify } } } },
        ...
        withStorageclass(storageclass): { spec+: { imageChartStorage+: { s3+: { storageclass: storageclass } } } },
        ...
        withV4auth(v4auth): { spec+: { imageChartStorage+: { s3+: { v4auth: v4auth } } } },
      },
      ...
      swift: {
        ...
        withAccesskey(accesskey): { spec+: { imageChartStorage+: { swift+: { accesskey: accesskey } } } },
        ...
        withAuthurl(authurl): { spec+: { imageChartStorage+: { swift+: { authurl: authurl } } } },
        ...
        withAuthversion(authversion): { spec+: { imageChartStorage+: { swift+: { authversion: authversion } } } },
        ...
        withChunksize(chunksize): { spec+: { imageChartStorage+: { swift+: { chunksize: chunksize } } } },
        ...
        withContainer(container): { spec+: { imageChartStorage+: { swift+: { container: container } } } },
        ...
        withDomain(domain): { spec+: { imageChartStorage+: { swift+: { domain: domain } } } },
        ...
        withDomainID(domainID): { spec+: { imageChartStorage+: { swift+: { domainID: domainID } } } },
        '#withEndpointtype':: d.fn(help='"The endpoint type used when connecting to swift."', args=[d.arg(name='endpointtype', type=d.T.string)]),
        withEndpointtype(endpointtype): { spec+: { imageChartStorage+: { swift+: { endpointtype: endpointtype } } } },
        ...
        withInsecureskipverify(insecureskipverify): { spec+: { imageChartStorage+: { swift+: { insecureskipverify: insecureskipverify } } } },
        '#withPasswordRef':: d.fn(help='"Secret name containing the Openstack password."', args=[d.arg(name='passwordRef', type=d.T.string)]),
        withPasswordRef(passwordRef): { spec+: { imageChartStorage+: { swift+: { passwordRef: passwordRef } } } },
        ...
        withTenant(tenant): { spec+: { imageChartStorage+: { swift+: { tenant: tenant } } } },
        ...
        withTenantID(tenantID): { spec+: { imageChartStorage+: { swift+: { tenantID: tenantID } } } },
        '#withTrustid':: d.fn(help='"Your Openstack trust ID for Identity v3 API."', args=[d.arg(name='trustid', type=d.T.string)]),
        withTrustid(trustid): { spec+: { imageChartStorage+: { swift+: { trustid: trustid } } } },
        '#withUsername':: d.fn(help='"The Openstack user name."', args=[d.arg(name='username', type=d.T.string)]),
        withUsername(username): { spec+: { imageChartStorage+: { swift+: { username: username } } } },
      },
    },
    ...
    '#inClusterCache':: d.obj(help='"Cache configuration for in-cluster cache services"'),
    inClusterCache: {
      '#redisSpec':: d.obj(help='"RedisSpec is the specification of redis."'),
      redisSpec: {
        '#imagePullSecrets':: d.obj(help=''),
        imagePullSecrets: {
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
        ...
        sentinel: {
          ...
          withReplicas(replicas): { spec+: { inClusterCache+: { redisSpec+: { sentinel+: { replicas: replicas } } } } },
        },
        ...
        server: {
          ...
          resources: {
            '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
            withLimits(limits): { spec+: { inClusterCache+: { redisSpec+: { server+: { resources+: { limits: limits } } } } } },
            '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
            withLimitsMixin(limits): { spec+: { inClusterCache+: { redisSpec+: { server+: { resources+: { limits+: limits } } } } } },
            '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
            withRequests(requests): { spec+: { inClusterCache+: { redisSpec+: { server+: { resources+: { requests: requests } } } } } },
            '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
            withRequestsMixin(requests): { spec+: { inClusterCache+: { redisSpec+: { server+: { resources+: { requests+: requests } } } } } },
          },
          '#withReplicas':: d.fn(help='"Replicas is the instance number of redis server."', args=[d.arg(name='replicas', type=d.T.integer)]),
          withReplicas(replicas): { spec+: { inClusterCache+: { redisSpec+: { server+: { replicas: replicas } } } } },
          '#withStorage':: d.fn(help='"Storage is the size of the redis storage."', args=[d.arg(name='storage', type=d.T.string)]),
          withStorage(storage): { spec+: { inClusterCache+: { redisSpec+: { server+: { storage: storage } } } } },
          ...
          withStorageClassName(storageClassName): { spec+: { inClusterCache+: { redisSpec+: { server+: { storageClassName: storageClassName } } } } },
        },
        '#withImage':: d.fn(help='"Image name for the component."', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { inClusterCache+: { redisSpec+: { image: image } } } },
        '#withImagePullPolicy':: d.fn(help='"Image pull policy. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images"', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
        withImagePullPolicy(imagePullPolicy): { spec+: { inClusterCache+: { redisSpec+: { imagePullPolicy: imagePullPolicy } } } },
        '#withImagePullSecrets':: d.fn(help='', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
        withImagePullSecrets(imagePullSecrets): { spec+: { inClusterCache+: { redisSpec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        '#withImagePullSecretsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
        withImagePullSecretsMixin(imagePullSecrets): { spec+: { inClusterCache+: { redisSpec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
      },
      '#withKind':: d.fn(help='"Set the kind of cache service to be used. Only support Redis now."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { inClusterCache+: { kind: kind } } },
    },
    '#inClusterDatabase':: d.obj(help='"Database configuration for in-cluster database service"'),
    inClusterDatabase: {
      '#postgresSqlSpec':: d.obj(help=''),
      postgresSqlSpec: {
        '#imagePullSecrets':: d.obj(help=''),
        imagePullSecrets: {
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
        ...
        '#resources':: d.obj(help='"Resources defines database pod resource config"'),
        resources: {
          '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
          withLimits(limits): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { resources+: { limits: limits } } } } },
          '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
          withLimitsMixin(limits): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { resources+: { limits+: limits } } } } },
          '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
          withRequests(requests): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { resources+: { requests: requests } } } } },
          '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
          withRequestsMixin(requests): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { resources+: { requests+: requests } } } } },
        },
        '#withImage':: d.fn(help='"Image name for the component."', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { image: image } } } },
        '#withImagePullPolicy':: d.fn(help='"Image pull policy. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images"', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
        withImagePullPolicy(imagePullPolicy): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { imagePullPolicy: imagePullPolicy } } } },
        '#withImagePullSecrets':: d.fn(help='', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
        withImagePullSecrets(imagePullSecrets): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        '#withImagePullSecretsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
        withImagePullSecretsMixin(imagePullSecrets): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        '#withReplicas':: d.fn(help='"Replicas defines database instance replicas"', args=[d.arg(name='replicas', type=d.T.integer)]),
        withReplicas(replicas): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { replicas: replicas } } } },
        '#withStorage':: d.fn(help='"Storage defines database data store pvc size"', args=[d.arg(name='storage', type=d.T.string)]),
        withStorage(storage): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { storage: storage } } } },
        '#withStorageClassName':: d.fn(help='"StorageClassName defines use which StorageClass to create pvc"', args=[d.arg(name='storageClassName', type=d.T.string)]),
        withStorageClassName(storageClassName): { spec+: { inClusterDatabase+: { postgresSqlSpec+: { storageClassName: storageClassName } } } },
      },
      '#withKind':: d.fn(help='"Set the kind of which database service to be used, Only support PostgresSQL now."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { inClusterDatabase+: { kind: kind } } },
    },
    '#inClusterStorage':: d.obj(help='"Storage configuration for in-cluster storage service"'),
    inClusterStorage: {
      '#minIOSpec':: d.obj(help='"inCLuster options."'),
      minIOSpec: {
        '#imagePullSecrets':: d.obj(help=''),
        imagePullSecrets: {
          '#withName':: d.fn(help='"Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names TODO: Add other useful fields. apiVersion, kind, uid?"', args=[d.arg(name='name', type=d.T.string)]),
        ...
        mc: {
          ...
          '#withImage':: d.fn(help='"Image name for the component."', args=[d.arg(name='image', type=d.T.string)]),
          withImage(image): { spec+: { inClusterStorage+: { minIOSpec+: { mc+: { image: image } } } } },
          '#withImagePullPolicy':: d.fn(help='"Image pull policy. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images"', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
          withImagePullPolicy(imagePullPolicy): { spec+: { inClusterStorage+: { minIOSpec+: { mc+: { imagePullPolicy: imagePullPolicy } } } } },
          '#withImagePullSecrets':: d.fn(help='', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
          withImagePullSecrets(imagePullSecrets): { spec+: { inClusterStorage+: { minIOSpec+: { mc+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } } },
          '#withImagePullSecretsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
          withImagePullSecretsMixin(imagePullSecrets): { spec+: { inClusterStorage+: { minIOSpec+: { mc+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } } },
        },
        ...
        redirect: {
          ...
          expose: {
            ...
            ingress: {
              '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
              withAnnotations(annotations): { spec+: { inClusterStorage+: { minIOSpec+: { redirect+: { expose+: { ingress+: { annotations: annotations } } } } } } },
              '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
              withAnnotationsMixin(annotations): { spec+: { inClusterStorage+: { minIOSpec+: { redirect+: { expose+: { ingress+: { annotations+: annotations } } } } } } },
              '#withController':: d.fn(help='"Set to the type of ingress controller."', args=[d.arg(name='controller', type=d.T.string)]),
              withController(controller): { spec+: { inClusterStorage+: { minIOSpec+: { redirect+: { expose+: { ingress+: { controller: controller } } } } } } },
              '#withHost':: d.fn(help='', args=[d.arg(name='host', type=d.T.string)]),
              withHost(host): { spec+: { inClusterStorage+: { minIOSpec+: { redirect+: { expose+: { ingress+: { host: host } } } } } } },
            },
            '#tls':: d.obj(help=''),
            tls: {
              '#withCertificateRef':: d.fn(help='', args=[d.arg(name='certificateRef', type=d.T.string)]),
              withCertificateRef(certificateRef): { spec+: { inClusterStorage+: { minIOSpec+: { redirect+: { expose+: { tls+: { certificateRef: certificateRef } } } } } } },
            },
          },
          '#withEnable':: d.fn(help='"Default is true"', args=[d.arg(name='enable', type=d.T.boolean)]),
          withEnable(enable): { spec+: { inClusterStorage+: { minIOSpec+: { redirect+: { enable: enable } } } } },
        },
        '#resources':: d.obj(help='"If provided, use these requests and limit for cpu/memory resource allocation"'),
        resources: {
          '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
          withLimits(limits): { spec+: { inClusterStorage+: { minIOSpec+: { resources+: { limits: limits } } } } },
          '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
          withLimitsMixin(limits): { spec+: { inClusterStorage+: { minIOSpec+: { resources+: { limits+: limits } } } } },
          '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
          withRequests(requests): { spec+: { inClusterStorage+: { minIOSpec+: { resources+: { requests: requests } } } } },
          '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
          withRequestsMixin(requests): { spec+: { inClusterStorage+: { minIOSpec+: { resources+: { requests+: requests } } } } },
        },
        ...
        volumeClaimTemplate: {
          ...
          spec: {
            ...
            dataSource: {
              ...
              withApiGroup(apiGroup): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { dataSource+: { apiGroup: apiGroup } } } } } } },
              '#withKind':: d.fn(help='"Kind is the type of resource being referenced"', args=[d.arg(name='kind', type=d.T.string)]),
              withKind(kind): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { dataSource+: { kind: kind } } } } } } },
              '#withName':: d.fn(help='"Name is the name of resource being referenced"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { dataSource+: { name: name } } } } } } },
            },
            ...
            dataSourceRef: {
              '#withApiGroup':: d.fn(help='"APIGroup is the group for the resource being referenced. If APIGroup is not specified, the specified Kind must be in the core API group. For any other third-party types, APIGroup is required."', args=[d.arg(name='apiGroup', type=d.T.string)]),
              withApiGroup(apiGroup): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { apiGroup: apiGroup } } } } } } },
              '#withKind':: d.fn(help='"Kind is the type of resource being referenced"', args=[d.arg(name='kind', type=d.T.string)]),
              withKind(kind): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { kind: kind } } } } } } },
              '#withName':: d.fn(help='"Name is the name of resource being referenced"', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { dataSourceRef+: { name: name } } } } } } },
            },
            ...
            resources: {
              '#withLimits':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='limits', type=d.T.object)]),
              withLimits(limits): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { resources+: { limits: limits } } } } } } },
              '#withLimitsMixin':: d.fn(help='"Limits describes the maximum amount of compute resources allowed. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='limits', type=d.T.object)]),
              withLimitsMixin(limits): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { resources+: { limits+: limits } } } } } } },
              '#withRequests':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"', args=[d.arg(name='requests', type=d.T.object)]),
              withRequests(requests): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { resources+: { requests: requests } } } } } } },
              '#withRequestsMixin':: d.fn(help='"Requests describes the minimum amount of compute resources required. If Requests is omitted for a container, it defaults to Limits if that is explicitly specified, otherwise to an implementation-defined value. More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requests', type=d.T.object)]),
              withRequestsMixin(requests): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { resources+: { requests+: requests } } } } } } },
            },
            ...
            selector: {
              ...
              withMatchExpressions(matchExpressions): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } } },
              '#withMatchExpressionsMixin':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
              withMatchExpressionsMixin(matchExpressions): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } } },
              '#withMatchLabels':: d.fn(help='"matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels map is equivalent to an element of matchExpressions, whose key field is \\"key\\", the operator is \\"In\\", and the values array contains only \\"value\\". The requirements are ANDed."', args=[d.arg(name='matchLabels', type=d.T.object)]),
              withMatchLabels(matchLabels): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { selector+: { matchLabels: matchLabels } } } } } } },
              ...
              withMatchLabelsMixin(matchLabels): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { selector+: { matchLabels+: matchLabels } } } } } } },
            },
            ...
            withAccessModes(accessModes): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } } },
            ...
            withAccessModesMixin(accessModes): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } } },
            ...
            withStorageClassName(storageClassName): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { storageClassName: storageClassName } } } } } },
            ...
            withVolumeMode(volumeMode): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { volumeMode: volumeMode } } } } } },
            ...
            withVolumeName(volumeName): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { spec+: { volumeName: volumeName } } } } } },
          },
          ...
          status: {
            ...
            withAccessModes(accessModes): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { accessModes: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } } },
            ...
            withAccessModesMixin(accessModes): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { accessModes+: if std.isArray(v=accessModes) then accessModes else [accessModes] } } } } } },
            ...
            withAllocatedResources(allocatedResources): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { allocatedResources: allocatedResources } } } } } },
            ...
            withAllocatedResourcesMixin(allocatedResources): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { allocatedResources+: allocatedResources } } } } } },
            '#withCapacity':: d.fn(help='"Represents the actual resources of the underlying volume."', args=[d.arg(name='capacity', type=d.T.object)]),
            withCapacity(capacity): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { capacity: capacity } } } } } },
            ...
            withCapacityMixin(capacity): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { capacity+: capacity } } } } } },
            ...
            withConditions(conditions): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { conditions: if std.isArray(v=conditions) then conditions else [conditions] } } } } } },
            ...
            withConditionsMixin(conditions): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { conditions+: if std.isArray(v=conditions) then conditions else [conditions] } } } } } },
            '#withPhase':: d.fn(help='"Phase represents the current phase of PersistentVolumeClaim."', args=[d.arg(name='phase', type=d.T.string)]),
            withPhase(phase): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { phase: phase } } } } } },
            ...
            withResizeStatus(resizeStatus): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { status+: { resizeStatus: resizeStatus } } } } } },
          },
          ...
          withApiVersion(apiVersion): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { apiVersion: apiVersion } } } } },
          ...
          withKind(kind): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { kind: kind } } } } },
          ...
          withMetadata(metadata): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { metadata: metadata } } } } },
          ...
          withMetadataMixin(metadata): { spec+: { inClusterStorage+: { minIOSpec+: { volumeClaimTemplate+: { metadata+: metadata } } } } },
        },
        '#withImage':: d.fn(help='"Image name for the component."', args=[d.arg(name='image', type=d.T.string)]),
        withImage(image): { spec+: { inClusterStorage+: { minIOSpec+: { image: image } } } },
        '#withImagePullPolicy':: d.fn(help='"Image pull policy. More info: https://kubernetes.io/docs/concepts/containers/images#updating-images"', args=[d.arg(name='imagePullPolicy', type=d.T.string)]),
        withImagePullPolicy(imagePullPolicy): { spec+: { inClusterStorage+: { minIOSpec+: { imagePullPolicy: imagePullPolicy } } } },
        '#withImagePullSecrets':: d.fn(help='', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
        withImagePullSecrets(imagePullSecrets): { spec+: { inClusterStorage+: { minIOSpec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        '#withImagePullSecretsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='imagePullSecrets', type=d.T.array)]),
        withImagePullSecretsMixin(imagePullSecrets): { spec+: { inClusterStorage+: { minIOSpec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        ...
        withReplicas(replicas): { spec+: { inClusterStorage+: { minIOSpec+: { replicas: replicas } } } },
        ...
        withSecretRef(secretRef): { spec+: { inClusterStorage+: { minIOSpec+: { secretRef: secretRef } } } },
        ...
        withVolumesPerServer(volumesPerServer): { spec+: { inClusterStorage+: { minIOSpec+: { volumesPerServer: volumesPerServer } } } },
      },
      '#withKind':: d.fn(help='"Kind of which storage service to be used. Only support MinIO now."', args=[d.arg(name='kind', type=d.T.string)]),
      withKind(kind): { spec+: { inClusterStorage+: { kind: kind } } },
    },
    ...
    '#redis':: d.obj(help='"Skip OpenAPI schema validation Use validating webhook to do verification (field required)"'),
    redis: {
