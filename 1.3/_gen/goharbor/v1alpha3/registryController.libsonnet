{
  ...
  '#':: d.pkg(name='registryController', url='', help='"RegistryController is the Schema for the RegistryController API."'),
  ...
  '#new':: d.fn(help='new returns an instance of RegistryController', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1alpha3',
    kind: 'RegistryController',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"RegistryControllerSpec defines the desired state of RegistryController."'),
  spec: {
    '#authentication':: d.obj(help=''),
    authentication: {
      '#withCoreSecretRef':: d.fn(help='', args=[d.arg(name='coreSecretRef', type=d.T.string)]),
      withCoreSecretRef(coreSecretRef): { spec+: { authentication+: { coreSecretRef: coreSecretRef } } },
      '#withJobServiceSecretRef':: d.fn(help='', args=[d.arg(name='jobServiceSecretRef', type=d.T.string)]),
      withJobServiceSecretRef(jobServiceSecretRef): { spec+: { authentication+: { jobServiceSecretRef: jobServiceSecretRef } } },
    },
    ...
    '#log':: d.obj(help=''),
    log: {
      '#withLevel':: d.fn(help='"RegistryCtlLogLevel is the log level for RegistryController."', args=[d.arg(name='level', type=d.T.string)]),
    ...
    '#withRegistryRef':: d.fn(help='', args=[d.arg(name='registryRef', type=d.T.string)]),
    withRegistryRef(registryRef): { spec+: { registryRef: registryRef } },
