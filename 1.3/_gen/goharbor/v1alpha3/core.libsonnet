{
  ...
  '#':: d.pkg(name='core', url='', help='"Core is the Schema for the Core API."'),
  ...
  '#new':: d.fn(help='new returns an instance of Core', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'goharbor.io/v1alpha3',
    kind: 'Core',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"CoreSpec defines the desired state of Core."'),
  spec: {
    '#components':: d.obj(help=''),
    components: {
      '#chartRepository':: d.obj(help=''),
      chartRepository: {
        '#withAbsoluteURL':: d.fn(help='', args=[d.arg(name='absoluteURL', type=d.T.boolean)]),
        withAbsoluteURL(absoluteURL): { spec+: { components+: { chartRepository+: { absoluteURL: absoluteURL } } } },
        '#withCacheDriver':: d.fn(help='', args=[d.arg(name='cacheDriver', type=d.T.string)]),
        withCacheDriver(cacheDriver): { spec+: { components+: { chartRepository+: { cacheDriver: cacheDriver } } } },
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { chartRepository+: { url: url } } } },
      },
      '#jobService':: d.obj(help=''),
      jobService: {
        '#withSecretRef':: d.fn(help='', args=[d.arg(name='secretRef', type=d.T.string)]),
        withSecretRef(secretRef): { spec+: { components+: { jobService+: { secretRef: secretRef } } } },
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { jobService+: { url: url } } } },
      },
      '#notaryServer':: d.obj(help=''),
      notaryServer: {
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { notaryServer+: { url: url } } } },
      },
      '#portal':: d.obj(help=''),
      portal: {
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { portal+: { url: url } } } },
      },
      '#registry':: d.obj(help=''),
      registry: {
        ...
        credentials: {
          ...
          withPasswordRef(passwordRef): { spec+: { components+: { registry+: { credentials+: { passwordRef: passwordRef } } } } },
          '#withUsername':: d.fn(help='', args=[d.arg(name='username', type=d.T.string)]),
          withUsername(username): { spec+: { components+: { registry+: { credentials+: { username: username } } } } },
        },
        '#redis':: d.obj(help=''),
        redis: {
          ...
          withCertificateRef(certificateRef): { spec+: { components+: { registry+: { redis+: { certificateRef: certificateRef } } } } },
          '#withDatabase':: d.fn(help='"The database number."', args=[d.arg(name='database', type=d.T.integer)]),
          withDatabase(database): { spec+: { components+: { registry+: { redis+: { database: database } } } } },
          '#withHost':: d.fn(help='"Server hostname."', args=[d.arg(name='host', type=d.T.string)]),
          withHost(host): { spec+: { components+: { registry+: { redis+: { host: host } } } } },
          ...
          withPasswordRef(passwordRef): { spec+: { components+: { registry+: { redis+: { passwordRef: passwordRef } } } } },
          '#withPort':: d.fn(help='"Server port."', args=[d.arg(name='port', type=d.T.integer)]),
          withPort(port): { spec+: { components+: { registry+: { redis+: { port: port } } } } },
          '#withSentinelMasterSet':: d.fn(help='"for Sentinel MasterSet."', args=[d.arg(name='sentinelMasterSet', type=d.T.string)]),
          withSentinelMasterSet(sentinelMasterSet): { spec+: { components+: { registry+: { redis+: { sentinelMasterSet: sentinelMasterSet } } } } },
        },
        '#withControllerURL':: d.fn(help='', args=[d.arg(name='controllerURL', type=d.T.string)]),
        withControllerURL(controllerURL): { spec+: { components+: { registry+: { controllerURL: controllerURL } } } },
        '#withStorageProviderName':: d.fn(help='', args=[d.arg(name='storageProviderName', type=d.T.string)]),
        withStorageProviderName(storageProviderName): { spec+: { components+: { registry+: { storageProviderName: storageProviderName } } } },
        '#withSync':: d.fn(help='', args=[d.arg(name='sync', type=d.T.boolean)]),
        withSync(sync): { spec+: { components+: { registry+: { sync: sync } } } },
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { registry+: { url: url } } } },
      },
      '#tls':: d.obj(help=''),
      tls: {
        '#withCertificateRef':: d.fn(help='', args=[d.arg(name='certificateRef', type=d.T.string)]),
        withCertificateRef(certificateRef): { spec+: { components+: { tls+: { certificateRef: certificateRef } } } },
      },
      '#tokenService':: d.obj(help=''),
      tokenService: {
        '#withCertificateRef':: d.fn(help='', args=[d.arg(name='certificateRef', type=d.T.string)]),
        withCertificateRef(certificateRef): { spec+: { components+: { tokenService+: { certificateRef: certificateRef } } } },
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { tokenService+: { url: url } } } },
      },
      '#trivy':: d.obj(help=''),
      trivy: {
        '#withAdapterURL':: d.fn(help='', args=[d.arg(name='adapterURL', type=d.T.string)]),
        withAdapterURL(adapterURL): { spec+: { components+: { trivy+: { adapterURL: adapterURL } } } },
        '#withUrl':: d.fn(help='', args=[d.arg(name='url', type=d.T.string)]),
        withUrl(url): { spec+: { components+: { trivy+: { url: url } } } },
      },
    },
    '#database':: d.obj(help=''),
    database: {
      ...
      withDatabase(database): { spec+: { database+: { database: database } } },
      '#withEncryptionKeyRef':: d.fn(help='', args=[d.arg(name='encryptionKeyRef', type=d.T.string)]),
      withEncryptionKeyRef(encryptionKeyRef): { spec+: { database+: { encryptionKeyRef: encryptionKeyRef } } },
      ...
      '#withMaxIdleConnections':: d.fn(help='', args=[d.arg(name='maxIdleConnections', type=d.T.integer)]),
      withMaxIdleConnections(maxIdleConnections): { spec+: { database+: { maxIdleConnections: maxIdleConnections } } },
      '#withMaxOpenConnections':: d.fn(help='', args=[d.arg(name='maxOpenConnections', type=d.T.integer)]),
      withMaxOpenConnections(maxOpenConnections): { spec+: { database+: { maxOpenConnections: maxOpenConnections } } },
      '#withParameters':: d.fn(help='"libpq parameters."', args=[d.arg(name='parameters', type=d.T.object)]),
      withParameters(parameters): { spec+: { database+: { parameters: parameters } } },
      ...
      withParametersMixin(parameters): { spec+: { database+: { parameters+: parameters } } },
    ...
    '#http':: d.obj(help=''),
    http: {
      '#withEnableGzip':: d.fn(help='', args=[d.arg(name='enableGzip', type=d.T.boolean)]),
      withEnableGzip(enableGzip): { spec+: { http+: { enableGzip: enableGzip } } },
    },
    ...
    '#log':: d.obj(help=''),
    log: {
      '#withLevel':: d.fn(help='"CoreLogLevel is the log level for Core."', args=[d.arg(name='level', type=d.T.string)]),
    ...
    redis: {
      ...
      withIdleTimeout(idleTimeout): { spec+: { redis+: { idleTimeout: idleTimeout } } },
      '#withPasswordRef':: d.fn(help='"Secret containing the password to use when connecting to the server."', args=[d.arg(name='passwordRef', type=d.T.string)]),
    ...
    '#withAdminInitialPasswordRef':: d.fn(help='', args=[d.arg(name='adminInitialPasswordRef', type=d.T.string)]),
    withAdminInitialPasswordRef(adminInitialPasswordRef): { spec+: { adminInitialPasswordRef: adminInitialPasswordRef } },
    '#withAuthMode':: d.fn(help='', args=[d.arg(name='authMode', type=d.T.string)]),
    withAuthMode(authMode): { spec+: { authMode: authMode } },
    ...
    '#withConfigExpiration':: d.fn(help='', args=[d.arg(name='configExpiration', type=d.T.string)]),
    withConfigExpiration(configExpiration): { spec+: { configExpiration: configExpiration } },
    '#withCsrfKeyRef':: d.fn(help='', args=[d.arg(name='csrfKeyRef', type=d.T.string)]),
    withCsrfKeyRef(csrfKeyRef): { spec+: { csrfKeyRef: csrfKeyRef } },
    '#withExternalEndpoint':: d.fn(help='', args=[d.arg(name='externalEndpoint', type=d.T.string)]),
    withExternalEndpoint(externalEndpoint): { spec+: { externalEndpoint: externalEndpoint } },
    ...
    '#withPublicCertificateRef':: d.fn(help='', args=[d.arg(name='publicCertificateRef', type=d.T.string)]),
    withPublicCertificateRef(publicCertificateRef): { spec+: { publicCertificateRef: publicCertificateRef } },
